...
//			_, err := grafana.NewOrganizationPreferences(ctx, "test", &grafana.OrganizationPreferencesArgs{
...
func NewOrganizationPreferences(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("grafana:index/organizationPreference:OrganizationPreference"),
		},
	})
