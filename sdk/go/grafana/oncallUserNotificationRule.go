...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserStep1", &grafana.OncallUserNotificationRuleArgs{
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserStep2", &grafana.OncallUserNotificationRuleArgs{
//				UserId:   pulumi.String(myUser.Id),
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserStep3", &grafana.OncallUserNotificationRuleArgs{
//				UserId:   pulumi.String(myUser.Id),
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserStep4", &grafana.OncallUserNotificationRuleArgs{
//				UserId:   pulumi.String(myUser.Id),
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserStep5", &grafana.OncallUserNotificationRuleArgs{
//				UserId:   pulumi.String(myUser.Id),
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserImportantStep1", &grafana.OncallUserNotificationRuleArgs{
//				UserId:    pulumi.String(myUser.Id),
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserImportantStep2", &grafana.OncallUserNotificationRuleArgs{
//				UserId:    pulumi.String(myUser.Id),
//				Important: pulumi.Bool(true),
//				Position:  pulumi.Int(1),
//				Duration:  pulumi.Int(300),
...
//				return err
//			}
//			_, err = grafana.NewOncallUserNotificationRule(ctx, "myUserImportantStep3", &grafana.OncallUserNotificationRuleArgs{
//				UserId:    pulumi.String(myUser.Id),
//				Important: pulumi.Bool(true),
//				Position:  pulumi.Int(2),
//				Type:      pulumi.String("notify_by_mobile_app_critical"),
