...
//
// > When using the `DataSourceConfig` resource, the corresponding `DataSource` resources must have the `jsonDataEncoded` and `httpHeaders` fields ignored. Otherwise, an infinite update loop will occur. See the example below.
//
// ## Example Usage
//
