...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:apps/v1beta1/dashboard:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("grafana:apps/v1beta1/dashboard:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
