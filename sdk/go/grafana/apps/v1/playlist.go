...
//				Metadata: &v1.PlaylistMetadataArgs{
//					Uid: pulumi.String("example-playlist"),
//				},
//				Spec: &v1.PlaylistSpecArgs{
//					Title:    pulumi.String("Example Playlist"),
//					Interval: pulumi.String("5m"),
//					Items: v1.PlaylistSpecItemArray{
//						&v1.PlaylistSpecItemArgs{
...
func NewPlaylist(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:apps/v1/playlist:Playlist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPlaylist(ctx *pulumi.Context,
	...
	var resource Playlist
	err := ctx.ReadResource("grafana:apps/v1/playlist:Playlist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
