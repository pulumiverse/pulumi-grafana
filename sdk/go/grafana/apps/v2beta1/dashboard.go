...
//	appsv2beta1 "github.com/pulumiverse/pulumi-grafana/sdk/v2/go/grafana/apps/v2beta1"
//
// )
//
//	func main() {
...
//				Metadata: &appsv2beta1.DashboardMetadataArgs{
//					Uid: pulumi.String("example-dashboard-v2"),
//				},
//				Spec: &appsv2beta1.DashboardSpecArgs{
...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:apps/v2beta1/dashboard:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("grafana:apps/v2beta1/dashboard:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
