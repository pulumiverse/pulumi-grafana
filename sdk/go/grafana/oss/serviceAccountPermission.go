...
func NewServiceAccountPermission(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:oss/serviceAccountPermission:ServiceAccountPermission", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccountPermission(ctx *pulumi.Context,
	...
	var resource ServiceAccountPermission
	err := ctx.ReadResource("grafana:oss/serviceAccountPermission:ServiceAccountPermission", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
