...
//				return err
//			}
//			_, err = oss.NewServiceAccountPermissionItem(ctx, "onTeam", &oss.ServiceAccountPermissionItemArgs{
...
//				return err
//			}
//			_, err = oss.NewServiceAccountPermissionItem(ctx, "onUser", &oss.ServiceAccountPermissionItemArgs{
//				ServiceAccountId: test.ID(),
//				User:             user.ID(),
//				Permission:       pulumi.String("Admin"),
//			})
...
func GetServiceAccountPermissionItem(ctx *pulumi.Context,
	...
	var resource ServiceAccountPermissionItem
	err := ctx.ReadResource("grafana:oss/serviceAccountPermissionItem:ServiceAccountPermissionItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
