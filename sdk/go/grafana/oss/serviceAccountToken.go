...
func NewServiceAccountToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:oss/serviceAccountToken:ServiceAccountToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccountToken(ctx *pulumi.Context,
	...
	var resource ServiceAccountToken
	err := ctx.ReadResource("grafana:oss/serviceAccountToken:ServiceAccountToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
