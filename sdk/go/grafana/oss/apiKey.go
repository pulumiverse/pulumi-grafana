...
//			foo, err := oss.NewApiKey(ctx, "foo", &oss.ApiKeyArgs{
//				Role: pulumi.String("Viewer"),
//			})
//			if err != nil {
//				return err
//			}
//			bar, err := oss.NewApiKey(ctx, "bar", &oss.ApiKeyArgs{
...
func NewApiKey(ctx *pulumi.Context,
	...
	var resource ApiKey
	err := ctx.RegisterResource("grafana:oss/apiKey:ApiKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiKey(ctx *pulumi.Context,
	...
	var resource ApiKey
	err := ctx.ReadResource("grafana:oss/apiKey:ApiKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
