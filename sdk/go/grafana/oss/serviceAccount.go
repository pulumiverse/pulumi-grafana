...
func NewServiceAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:oss/serviceAccount:ServiceAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccount(ctx *pulumi.Context,
	...
	var resource ServiceAccount
	err := ctx.ReadResource("grafana:oss/serviceAccount:ServiceAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
