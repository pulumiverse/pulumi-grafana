...
type SLOAlertingArgs struct {
	...
	// Alerting Rules generated for Fast Burn alerts
	Fastburn SLOAlertingFastburnPtrInput `pulumi:"fastburn"`
	// Labels will be attached to all alerts generated by any of these rules.
	Labels SLOAlertingLabelArrayInput `pulumi:"labels"`
	// Alerting Rules generated for Slow Burn alerts
	Slowburn SLOAlertingSlowburnPtrInput `pulumi:"slowburn"`
}
...
func (i SLOAlertingArgs) ToSLOAlertingPtrOutput() SLOAlertingPtrOutput {
	return i.ToSLOAlertingPtrOutputWithContext(context.Background())
}

func (i SLOAlertingArgs) ToSLOAlertingPtrOutputWithContext(ctx context.Context) SLOAlertingPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SLOAlertingOutput).ToSLOAlertingPtrOutputWithContext(ctx)
}

// SLOAlertingPtrInput is an input type that accepts SLOAlertingArgs, SLOAlertingPtr and SLOAlertingPtrOutput values.
// You can construct a concrete instance of `SLOAlertingPtrInput` via:
//
//	        SLOAlertingArgs{...}
//
//	or:
//
//	        nil
type SLOAlertingPtrInput interface {
	pulumi.Input

	ToSLOAlertingPtrOutput() SLOAlertingPtrOutput
	ToSLOAlertingPtrOutputWithContext(context.Context) SLOAlertingPtrOutput
}

type sloalertingPtrType SLOAlertingArgs

func SLOAlertingPtr(v *SLOAlertingArgs) SLOAlertingPtrInput {
	return (*sloalertingPtrType)(v)
}

func (*sloalertingPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SLOAlerting)(nil)).Elem()
}

func (i *sloalertingPtrType) ToSLOAlertingPtrOutput() SLOAlertingPtrOutput {
	return i.ToSLOAlertingPtrOutputWithContext(context.Background())
}

func (i *sloalertingPtrType) ToSLOAlertingPtrOutputWithContext(ctx context.Context) SLOAlertingPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SLOAlertingPtrOutput)
}
...
func (o SLOAlertingOutput) ToSLOAlertingPtrOutput() SLOAlertingPtrOutput {
	return o.ToSLOAlertingPtrOutputWithContext(context.Background())
}

func (o SLOAlertingOutput) ToSLOAlertingPtrOutputWithContext(ctx context.Context) SLOAlertingPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SLOAlerting) *SLOAlerting {
		return &v
	}).(SLOAlertingPtrOutput)
}
...
// Alerting Rules generated for Fast Burn alerts
func (o SLOAlertingOutput) Fastburn() SLOAlertingFastburnPtrOutput {
	return o.ApplyT(func(v SLOAlerting) *SLOAlertingFastburn { return v.Fastburn }).(SLOAlertingFastburnPtrOutput)
}
...
// Alerting Rules generated for Slow Burn alerts
func (o SLOAlertingOutput) Slowburn() SLOAlertingSlowburnPtrOutput {
	return o.ApplyT(func(v SLOAlerting) *SLOAlertingSlowburn { return v.Slowburn }).(SLOAlertingSlowburnPtrOutput)
}

type SLOAlertingPtrOutput struct{ *pulumi.OutputState }

func (SLOAlertingPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SLOAlerting)(nil)).Elem()
}

func (o SLOAlertingPtrOutput) ToSLOAlertingPtrOutput() SLOAlertingPtrOutput {
	return o
}

func (o SLOAlertingPtrOutput) ToSLOAlertingPtrOutputWithContext(ctx context.Context) SLOAlertingPtrOutput {
	return o
}

func (o SLOAlertingPtrOutput) Elem() SLOAlertingOutput {
	return o.ApplyT(func(v *SLOAlerting) SLOAlerting {
		if v != nil {
			return *v
		}
		var ret SLOAlerting
...
// Advanced Options for Alert Rules
func (o SLOAlertingPtrOutput) AdvancedOptions() SLOAlertingAdvancedOptionsPtrOutput {
	return o.ApplyT(func(v *SLOAlerting) *SLOAlertingAdvancedOptions {
		if v == nil {
			return nil
		}
...
// Annotations will be attached to all alerts generated by any of these rules.
func (o SLOAlertingPtrOutput) Annotations() SLOAlertingAnnotationArrayOutput {
	return o.ApplyT(func(v *SLOAlerting) []SLOAlertingAnnotation {
		if v == nil {
			return nil
		}
		return v.Annotations
	}).(SLOAlertingAnnotationArrayOutput)
}

// Alerting Rules generated for Fast Burn alerts
func (o SLOAlertingPtrOutput) Fastburn() SLOAlertingFastburnPtrOutput {
	return o.ApplyT(func(v *SLOAlerting) *SLOAlertingFastburn {
		if v == nil {
			return nil
		}
		return v.Fastburn
	}).(SLOAlertingFastburnPtrOutput)
}

// Labels will be attached to all alerts generated by any of these rules.
func (o SLOAlertingPtrOutput) Labels() SLOAlertingLabelArrayOutput {
	return o.ApplyT(func(v *SLOAlerting) []SLOAlertingLabel {
		if v == nil {
			return nil
		}
		return v.Labels
	}).(SLOAlertingLabelArrayOutput)
}

// Alerting Rules generated for Slow Burn alerts
func (o SLOAlertingPtrOutput) Slowburn() SLOAlertingSlowburnPtrOutput {
	return o.ApplyT(func(v *SLOAlerting) *SLOAlertingSlowburn {
		if v == nil {
			return nil
		}
		return v.Slowburn
	}).(SLOAlertingSlowburnPtrOutput)
}
...
func (i SLOAlertingFastburnArgs) ToSLOAlertingFastburnPtrOutput() SLOAlertingFastburnPtrOutput {
	return i.ToSLOAlertingFastburnPtrOutputWithContext(context.Background())
}

func (i SLOAlertingFastburnArgs) ToSLOAlertingFastburnPtrOutputWithContext(ctx context.Context) SLOAlertingFastburnPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SLOAlertingFastburnOutput).ToSLOAlertingFastburnPtrOutputWithContext(ctx)
}

// SLOAlertingFastburnPtrInput is an input type that accepts SLOAlertingFastburnArgs, SLOAlertingFastburnPtr and SLOAlertingFastburnPtrOutput values.
// You can construct a concrete instance of `SLOAlertingFastburnPtrInput` via:
//
//	        SLOAlertingFastburnArgs{...}
//
//	or:
//
//	        nil
type SLOAlertingFastburnPtrInput interface {
	pulumi.Input

	ToSLOAlertingFastburnPtrOutput() SLOAlertingFastburnPtrOutput
	ToSLOAlertingFastburnPtrOutputWithContext(context.Context) SLOAlertingFastburnPtrOutput
}

type sloalertingFastburnPtrType SLOAlertingFastburnArgs

func SLOAlertingFastburnPtr(v *SLOAlertingFastburnArgs) SLOAlertingFastburnPtrInput {
	return (*sloalertingFastburnPtrType)(v)
}

func (*sloalertingFastburnPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SLOAlertingFastburn)(nil)).Elem()
}

func (i *sloalertingFastburnPtrType) ToSLOAlertingFastburnPtrOutput() SLOAlertingFastburnPtrOutput {
	return i.ToSLOAlertingFastburnPtrOutputWithContext(context.Background())
}

func (i *sloalertingFastburnPtrType) ToSLOAlertingFastburnPtrOutputWithContext(ctx context.Context) SLOAlertingFastburnPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SLOAlertingFastburnPtrOutput)
}
...
func (o SLOAlertingFastburnOutput) ToSLOAlertingFastburnPtrOutput() SLOAlertingFastburnPtrOutput {
	return o.ToSLOAlertingFastburnPtrOutputWithContext(context.Background())
}

func (o SLOAlertingFastburnOutput) ToSLOAlertingFastburnPtrOutputWithContext(ctx context.Context) SLOAlertingFastburnPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SLOAlertingFastburn) *SLOAlertingFastburn {
		return &v
	}).(SLOAlertingFastburnPtrOutput)
}
...
type SLOAlertingFastburnPtrOutput struct{ *pulumi.OutputState }

func (SLOAlertingFastburnPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SLOAlertingFastburn)(nil)).Elem()
}

func (o SLOAlertingFastburnPtrOutput) ToSLOAlertingFastburnPtrOutput() SLOAlertingFastburnPtrOutput {
	return o
}

func (o SLOAlertingFastburnPtrOutput) ToSLOAlertingFastburnPtrOutputWithContext(ctx context.Context) SLOAlertingFastburnPtrOutput {
	return o
}

func (o SLOAlertingFastburnPtrOutput) Elem() SLOAlertingFastburnOutput {
	return o.ApplyT(func(v *SLOAlertingFastburn) SLOAlertingFastburn {
		if v != nil {
			return *v
		}
		var ret SLOAlertingFastburn
		return ret
	}).(SLOAlertingFastburnOutput)
}

// Annotations to attach only to Fast Burn alerts.
func (o SLOAlertingFastburnPtrOutput) Annotations() SLOAlertingFastburnAnnotationArrayOutput {
	return o.ApplyT(func(v *SLOAlertingFastburn) []SLOAlertingFastburnAnnotation {
		if v == nil {
			return nil
		}
		return v.Annotations
...
// Labels to attach only to Fast Burn alerts.
func (o SLOAlertingFastburnPtrOutput) Labels() SLOAlertingFastburnLabelArrayOutput {
	return o.ApplyT(func(v *SLOAlertingFastburn) []SLOAlertingFastburnLabel {
		if v == nil {
			return nil
		}
		return v.Labels
	}).(SLOAlertingFastburnLabelArrayOutput)
}
...
func (i SLOAlertingSlowburnArgs) ToSLOAlertingSlowburnPtrOutput() SLOAlertingSlowburnPtrOutput {
	return i.ToSLOAlertingSlowburnPtrOutputWithContext(context.Background())
}

func (i SLOAlertingSlowburnArgs) ToSLOAlertingSlowburnPtrOutputWithContext(ctx context.Context) SLOAlertingSlowburnPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SLOAlertingSlowburnOutput).ToSLOAlertingSlowburnPtrOutputWithContext(ctx)
}

// SLOAlertingSlowburnPtrInput is an input type that accepts SLOAlertingSlowburnArgs, SLOAlertingSlowburnPtr and SLOAlertingSlowburnPtrOutput values.
// You can construct a concrete instance of `SLOAlertingSlowburnPtrInput` via:
//
//	        SLOAlertingSlowburnArgs{...}
//
//	or:
//
//	        nil
type SLOAlertingSlowburnPtrInput interface {
	pulumi.Input

	ToSLOAlertingSlowburnPtrOutput() SLOAlertingSlowburnPtrOutput
	ToSLOAlertingSlowburnPtrOutputWithContext(context.Context) SLOAlertingSlowburnPtrOutput
}

type sloalertingSlowburnPtrType SLOAlertingSlowburnArgs

func SLOAlertingSlowburnPtr(v *SLOAlertingSlowburnArgs) SLOAlertingSlowburnPtrInput {
	return (*sloalertingSlowburnPtrType)(v)
}

func (*sloalertingSlowburnPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SLOAlertingSlowburn)(nil)).Elem()
}

func (i *sloalertingSlowburnPtrType) ToSLOAlertingSlowburnPtrOutput() SLOAlertingSlowburnPtrOutput {
	return i.ToSLOAlertingSlowburnPtrOutputWithContext(context.Background())
}

func (i *sloalertingSlowburnPtrType) ToSLOAlertingSlowburnPtrOutputWithContext(ctx context.Context) SLOAlertingSlowburnPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SLOAlertingSlowburnPtrOutput)
}
...
func (o SLOAlertingSlowburnOutput) ToSLOAlertingSlowburnPtrOutput() SLOAlertingSlowburnPtrOutput {
	return o.ToSLOAlertingSlowburnPtrOutputWithContext(context.Background())
}

func (o SLOAlertingSlowburnOutput) ToSLOAlertingSlowburnPtrOutputWithContext(ctx context.Context) SLOAlertingSlowburnPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SLOAlertingSlowburn) *SLOAlertingSlowburn {
		return &v
	}).(SLOAlertingSlowburnPtrOutput)
}
...
type SLOAlertingSlowburnPtrOutput struct{ *pulumi.OutputState }

func (SLOAlertingSlowburnPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SLOAlertingSlowburn)(nil)).Elem()
}

func (o SLOAlertingSlowburnPtrOutput) ToSLOAlertingSlowburnPtrOutput() SLOAlertingSlowburnPtrOutput {
	return o
}

func (o SLOAlertingSlowburnPtrOutput) ToSLOAlertingSlowburnPtrOutputWithContext(ctx context.Context) SLOAlertingSlowburnPtrOutput {
	return o
}

func (o SLOAlertingSlowburnPtrOutput) Elem() SLOAlertingSlowburnOutput {
	return o.ApplyT(func(v *SLOAlertingSlowburn) SLOAlertingSlowburn {
		if v != nil {
			return *v
		}
		var ret SLOAlertingSlowburn
		return ret
	}).(SLOAlertingSlowburnOutput)
}

// Annotations to attach only to Slow Burn alerts.
func (o SLOAlertingSlowburnPtrOutput) Annotations() SLOAlertingSlowburnAnnotationArrayOutput {
	return o.ApplyT(func(v *SLOAlertingSlowburn) []SLOAlertingSlowburnAnnotation {
		if v == nil {
			return nil
		}
		return v.Annotations
...
// Labels to attach only to Slow Burn alerts.
func (o SLOAlertingSlowburnPtrOutput) Labels() SLOAlertingSlowburnLabelArrayOutput {
	return o.ApplyT(func(v *SLOAlertingSlowburn) []SLOAlertingSlowburnLabel {
		if v == nil {
			return nil
		}
		return v.Labels
	}).(SLOAlertingSlowburnLabelArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SLOAlertingPtrInput)(nil)).Elem(), SLOAlertingArgs{})
	...
	pulumi.RegisterOutputType(SLOAlertingPtrOutput{})
