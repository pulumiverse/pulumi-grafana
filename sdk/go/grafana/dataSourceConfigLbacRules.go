...
func NewDataSourceConfigLbacRules(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("grafana:index/dataSourceConfigLbacRules:DataSourceConfigLbacRules", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSourceConfigLbacRules(ctx *pulumi.Context,
	...
	var resource DataSourceConfigLbacRules
	err := ctx.ReadResource("grafana:index/dataSourceConfigLbacRules:DataSourceConfigLbacRules", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
