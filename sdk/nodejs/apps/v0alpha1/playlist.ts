...
export class Playlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:apps/v0alpha1/playlist:Playlist';
     ...
     */
    declare public readonly metadata: pulumi.Output<outputs.apps.v0alpha1.PlaylistMetadata | undefined>;
    /**
     * Options for applying the resource.
     */
    declare public readonly options: pulumi.Output<outputs.apps.v0alpha1.PlaylistOptions | undefined>;
    /**
     * The spec of the resource.
     */
    declare public readonly spec: pulumi.Output<outputs.apps.v0alpha1.PlaylistSpec | undefined>;
...
export interface PlaylistState {
     ...
     * The metadata of the resource.
     */
    metadata?: pulumi.Input<inputs.apps.v0alpha1.PlaylistMetadata>;
    /**
     * Options for applying the resource.
     */
    options?: pulumi.Input<inputs.apps.v0alpha1.PlaylistOptions>;
    /**
     * The spec of the resource.
     */
    spec?: pulumi.Input<inputs.apps.v0alpha1.PlaylistSpec>;
}
