...
export class DataSourcePermission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:enterprise/dataSourcePermission:DataSourcePermission';
     ...
     */
    declare public readonly permissions: pulumi.Output<outputs.enterprise.DataSourcePermissionPermission[] | undefined>;
