...
export class Route extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:onCall/route:Route';
...
export interface RouteState {
     ...
     * MS teams-specific settings for a route.
     */
    msteams?: pulumi.Input<inputs.onCall.RouteMsteams>;
    /**
     * The position of the route (starts from 0).
     */
     ...
     * Slack-specific settings for a route.
     */
    slack?: pulumi.Input<inputs.onCall.RouteSlack>;
    /**
     * Telegram-specific settings for a route.
     */
    telegram?: pulumi.Input<inputs.onCall.RouteTelegram>;
}
