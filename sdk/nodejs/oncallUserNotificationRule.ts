 ...
 * });
 * const myUserStep1 = new grafana.OncallUserNotificationRule("myUserStep1", {
 ...
 * });
 * const myUserStep2 = new grafana.OncallUserNotificationRule("myUserStep2", {
 *     userId: myUser.then(myUser => myUser.id),
 *     position: 1,
 *     duration: 600,
 *     type: "wait",
 ...
 *     provider: grafana.oncall,
 * });
 * const myUserStep3 = new grafana.OncallUserNotificationRule("myUserStep3", {
 *     userId: myUser.then(myUser => myUser.id),
 *     position: 2,
 ...
 *     provider: grafana.oncall,
 * });
 * const myUserStep4 = new grafana.OncallUserNotificationRule("myUserStep4", {
 *     userId: myUser.then(myUser => myUser.id),
 *     position: 3,
 *     duration: 300,
 *     type: "wait",
 ...
 *     provider: grafana.oncall,
 * });
 * const myUserStep5 = new grafana.OncallUserNotificationRule("myUserStep5", {
 *     userId: myUser.then(myUser => myUser.id),
 *     position: 4,
 ...
 *     provider: grafana.oncall,
 * });
 * const myUserImportantStep1 = new grafana.OncallUserNotificationRule("myUserImportantStep1", {
 *     userId: myUser.then(myUser => myUser.id),
 *     important: true,
 *     position: 0,
 ...
 *     provider: grafana.oncall,
 * });
 * const myUserImportantStep2 = new grafana.OncallUserNotificationRule("myUserImportantStep2", {
 *     userId: myUser.then(myUser => myUser.id),
 *     important: true,
 *     position: 1,
 *     duration: 300,
 ...
 *     provider: grafana.oncall,
 * });
 * const myUserImportantStep3 = new grafana.OncallUserNotificationRule("myUserImportantStep3", {
 *     userId: myUser.then(myUser => myUser.id),
 *     important: true,
 *     position: 2,
 *     type: "notify_by_mobile_app_critical",
