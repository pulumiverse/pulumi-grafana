 ...
 *     role: "Viewer",
 * });
 * const foo = new grafana.ServiceAccountRotatingToken("foo", {
 *     namePrefix: "key_foo",
...
export class ServiceAccountRotatingToken extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:index/serviceAccountRotatingToken:ServiceAccountRotatingToken';
