...
export class DashboardPermission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:oss/dashboardPermission:DashboardPermission';
     ...
     */
    declare public readonly permissions: pulumi.Output<outputs.oss.DashboardPermissionPermission[] | undefined>;
