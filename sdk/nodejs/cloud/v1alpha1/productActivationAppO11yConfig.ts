 ...
 * ```
 */
export class ProductActivationAppO11yConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProductActivationAppO11yConfigState, opts?: pulumi.CustomResourceOptions): ProductActivationAppO11yConfig {
        return new ProductActivationAppO11yConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'grafana:cloud/v1alpha1/productActivationAppO11yConfig:ProductActivationAppO11yConfig';
     ...
     */
    public static isInstance(obj: any): obj is ProductActivationAppO11yConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProductActivationAppO11yConfig.__pulumiType;
    }

    /**
     * The metadata of the resource.
     */
    declare public readonly metadata: pulumi.Output<outputs.cloud.v1alpha1.ProductActivationAppO11yConfigMetadata | undefined>;
    /**
     * Options for applying the resource.
     */
    declare public readonly options: pulumi.Output<outputs.cloud.v1alpha1.ProductActivationAppO11yConfigOptions | undefined>;
    /**
     * The spec of the resource.
     */
    declare public readonly spec: pulumi.Output<outputs.cloud.v1alpha1.ProductActivationAppO11yConfigSpec | undefined>;
    ...
    constructor(name: string, argsOrState?: ProductActivationAppO11yConfigArgs | ProductActivationAppO11yConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProductActivationAppO11yConfigState | undefined;
            resourceInputs["metadata"] = state?.metadata;
            resourceInputs["options"] = state?.options;
            resourceInputs["spec"] = state?.spec;
        } else {
            const args = argsOrState as ProductActivationAppO11yConfigArgs | undefined;
        ...
        super(ProductActivationAppO11yConfig.__pulumiType, name, resourceInputs, opts);
    }
}
