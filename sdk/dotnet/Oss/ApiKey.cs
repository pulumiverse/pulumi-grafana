...
namespace Pulumiverse.Grafana.Oss
{
    ...
    /// {
    ///     var foo = new Grafana.Oss.ApiKey("foo", new()
    ///     {
    ///         Role = "Viewer",
    ///     });
    /// 
    ///     var bar = new Grafana.Oss.ApiKey("bar", new()
    ///     {
    ///         Role = "Admin",
    ///         SecondsToLive = 30,
    ///     });
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:oss/apiKey:ApiKey")]
    public partial class ApiKey : global::Pulumi.CustomResource
    {
        ...
        public ApiKey(string name, ApiKeyArgs args, CustomResourceOptions? options = null)
            : base("grafana:oss/apiKey:ApiKey", name, args ?? new ApiKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiKey(string name, Input<string> id, ApiKeyState? state = null, CustomResourceOptions? options = null)
            : base("grafana:oss/apiKey:ApiKey", name, state, MakeResourceOptions(options, id))
        {
        }
