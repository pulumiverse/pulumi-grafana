...
namespace Pulumiverse.Grafana.Oss
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:oss/folderPermissionItem:FolderPermissionItem")]
    public partial class FolderPermissionItem : global::Pulumi.CustomResource
    {
        ...
        public FolderPermissionItem(string name, FolderPermissionItemArgs args, CustomResourceOptions? options = null)
            : base("grafana:oss/folderPermissionItem:FolderPermissionItem", name, args ?? new FolderPermissionItemArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private FolderPermissionItem(string name, Input<string> id, FolderPermissionItemState? state = null, CustomResourceOptions? options = null)
            : base("grafana:oss/folderPermissionItem:FolderPermissionItem", name, state, MakeResourceOptions(options, id))
        {
        }
