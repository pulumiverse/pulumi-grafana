...
namespace Pulumiverse.Grafana.Oss
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:oss/serviceAccountToken:ServiceAccountToken")]
    public partial class ServiceAccountToken : global::Pulumi.CustomResource
    {
        ...
        public ServiceAccountToken(string name, ServiceAccountTokenArgs args, CustomResourceOptions? options = null)
            : base("grafana:oss/serviceAccountToken:ServiceAccountToken", name, args ?? new ServiceAccountTokenArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ServiceAccountToken(string name, Input<string> id, ServiceAccountTokenState? state = null, CustomResourceOptions? options = null)
            : base("grafana:oss/serviceAccountToken:ServiceAccountToken", name, state, MakeResourceOptions(options, id))
        {
        }
