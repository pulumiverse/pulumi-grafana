...
namespace Pulumiverse.Grafana.Oss
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:oss/organization:Organization")]
    public partial class Organization : global::Pulumi.CustomResource
    {
        ...
        public Organization(string name, OrganizationArgs? args = null, CustomResourceOptions? options = null)
            : base("grafana:oss/organization:Organization", name, args ?? new OrganizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Organization(string name, Input<string> id, OrganizationState? state = null, CustomResourceOptions? options = null)
            : base("grafana:oss/organization:Organization", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "grafana:index/organization:Organization" },
                },
            };
