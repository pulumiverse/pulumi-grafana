...
namespace Pulumiverse.Grafana.Oss.Inputs
{
    ...
    public sealed class SsoSettingsLdapSettingsConfigServerArgs : global::Pulumi.ResourceArgs
    {
        [Input("attributes")]
        ...
        [Input("groupMappings")]
        private InputList<Inputs.SsoSettingsLdapSettingsConfigServerGroupMappingArgs>? _groupMappings;

        /// <summary>
        /// For mapping an LDAP group to a Grafana organization and role.
        /// </summary>
        public InputList<Inputs.SsoSettingsLdapSettingsConfigServerGroupMappingArgs> GroupMappings
        {
            get => _groupMappings ?? (_groupMappings = new InputList<Inputs.SsoSettingsLdapSettingsConfigServerGroupMappingArgs>());
        ...
        public SsoSettingsLdapSettingsConfigServerArgs()
        {
        }
        public static new SsoSettingsLdapSettingsConfigServerArgs Empty => new SsoSettingsLdapSettingsConfigServerArgs();
    }
}
