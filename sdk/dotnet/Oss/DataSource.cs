...
namespace Pulumiverse.Grafana.Oss
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:oss/dataSource:DataSource")]
    public partial class DataSource : global::Pulumi.CustomResource
    {
        ...
        public DataSource(string name, DataSourceArgs args, CustomResourceOptions? options = null)
            : base("grafana:oss/dataSource:DataSource", name, args ?? new DataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSource(string name, Input<string> id, DataSourceState? state = null, CustomResourceOptions? options = null)
            : base("grafana:oss/dataSource:DataSource", name, state, MakeResourceOptions(options, id))
        {
        }
