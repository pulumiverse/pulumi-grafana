...
namespace Pulumiverse.Grafana.Inputs
{
    ...
    public sealed class AppsNotificationsRoutingtreeV1beta1SpecRouteGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteMatcherGetArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteMatcherGetArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteMatcherGetArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteRouteGetArgs>? _routes;

        /// <summary>
        /// Child routes. Each child route has the same schema as `spec.routes` and may be nested up to 5 levels deep.
        /// </summary>
        public InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteRouteGetArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteRouteGetArgs>());
            set => _routes = value;
        }

        public AppsNotificationsRoutingtreeV1beta1SpecRouteGetArgs()
        {
        }
        public static new AppsNotificationsRoutingtreeV1beta1SpecRouteGetArgs Empty => new AppsNotificationsRoutingtreeV1beta1SpecRouteGetArgs();
    }
}
