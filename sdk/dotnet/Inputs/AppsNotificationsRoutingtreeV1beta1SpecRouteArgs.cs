...
namespace Pulumiverse.Grafana.Inputs
{
    ...
    public sealed class AppsNotificationsRoutingtreeV1beta1SpecRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteMatcherArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteMatcherArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteMatcherArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteRouteArgs>? _routes;

        /// <summary>
        /// Child routes. Each child route has the same schema as `spec.routes` and may be nested up to 5 levels deep.
        /// </summary>
        public InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.AppsNotificationsRoutingtreeV1beta1SpecRouteRouteArgs>());
            set => _routes = value;
        }

        public AppsNotificationsRoutingtreeV1beta1SpecRouteArgs()
        {
        }
        public static new AppsNotificationsRoutingtreeV1beta1SpecRouteArgs Empty => new AppsNotificationsRoutingtreeV1beta1SpecRouteArgs();
    }
}
