...
namespace Pulumiverse.Grafana.Alerting.Inputs
{
    ...
    public sealed class NotificationPolicyPolicyPolicyPolicyPolicyPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("activeTimings")]
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationPolicyPolicyPolicyPolicyPolicyPolicyMatcherGetArgs>? _matchers;

        /// <summary>
        /// Describes which labels this rule should match. When multiple matchers are supplied, an alert must match ALL matchers to be accepted by this policy. When no matchers are supplied, the rule will match all alert instances.
        /// </summary>
        public InputList<Inputs.NotificationPolicyPolicyPolicyPolicyPolicyPolicyMatcherGetArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationPolicyPolicyPolicyPolicyPolicyPolicyMatcherGetArgs>());
            set => _matchers = value;
        }
        ...
        public NotificationPolicyPolicyPolicyPolicyPolicyPolicyGetArgs()
        {
        }
        public static new NotificationPolicyPolicyPolicyPolicyPolicyPolicyGetArgs Empty => new NotificationPolicyPolicyPolicyPolicyPolicyPolicyGetArgs();
    }
}
