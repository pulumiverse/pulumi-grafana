...
namespace Pulumiverse.Grafana.Alerting.Inputs
{
    ...
    public sealed class AlertRuleV0Alpha1SpecGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("panelRef")]
        public Input<Inputs.AlertRuleV0Alpha1SpecPanelRefGetArgs>? PanelRef { get; set; }
        ...
        /// </summary>
        [Input("trigger")]
        public Input<Inputs.AlertRuleV0Alpha1SpecTriggerGetArgs>? Trigger { get; set; }

        public AlertRuleV0Alpha1SpecGetArgs()
        {
        }
        public static new AlertRuleV0Alpha1SpecGetArgs Empty => new AlertRuleV0Alpha1SpecGetArgs();
    }
}
