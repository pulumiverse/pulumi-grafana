...
namespace Pulumiverse.Grafana.Alerting.V0Alpha1.Inputs
{
    ...
    public sealed class AlertRuleSpecGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public Input<Inputs.AlertRuleSpecNotificationSettingsGetArgs>? NotificationSettings { get; set; }
        ...
        /// </summary>
        [Input("trigger")]
        public Input<Inputs.AlertRuleSpecTriggerGetArgs>? Trigger { get; set; }

        public AlertRuleSpecGetArgs()
        {
        }
        public static new AlertRuleSpecGetArgs Empty => new AlertRuleSpecGetArgs();
    }
}
