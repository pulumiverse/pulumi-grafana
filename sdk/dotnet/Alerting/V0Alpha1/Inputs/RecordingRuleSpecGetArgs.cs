...
namespace Pulumiverse.Grafana.Alerting.V0Alpha1.Inputs
{
    ...
    public sealed class RecordingRuleSpecGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("trigger")]
        public Input<Inputs.RecordingRuleSpecTriggerGetArgs>? Trigger { get; set; }

        public RecordingRuleSpecGetArgs()
        {
        }
        public static new RecordingRuleSpecGetArgs Empty => new RecordingRuleSpecGetArgs();
    }
}
