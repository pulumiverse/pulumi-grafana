...
namespace Pulumiverse.Grafana.Alerting.V0Alpha1.Inputs
{
    ...
    public sealed class AlertRuleSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public Input<Inputs.AlertRuleSpecNotificationSettingsArgs>? NotificationSettings { get; set; }
        ...
        /// </summary>
        [Input("trigger")]
        public Input<Inputs.AlertRuleSpecTriggerArgs>? Trigger { get; set; }

        public AlertRuleSpecArgs()
        {
        }
        public static new AlertRuleSpecArgs Empty => new AlertRuleSpecArgs();
    }
}
