...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteMatcherArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteMatcherArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteMatcherArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteRouteArgs>? _routes;

        /// <summary>
        /// Child routes of this route.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteRouteArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs Empty => new NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs();
    }
}
