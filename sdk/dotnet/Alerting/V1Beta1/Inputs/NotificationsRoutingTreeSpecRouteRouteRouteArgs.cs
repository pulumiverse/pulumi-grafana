...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteRouteRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteMatcherArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteMatcherArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteMatcherArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs>? _routes;

        /// <summary>
        /// Child routes of this route.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteRouteRouteArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteRouteRouteArgs Empty => new NotificationsRoutingTreeSpecRouteRouteRouteArgs();
    }
}
