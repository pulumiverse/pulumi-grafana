...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteMatcherArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteMatcherArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteMatcherArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteArgs>? _routes;

        /// <summary>
        /// Child routes of this route.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteRouteArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteRouteArgs Empty => new NotificationsRoutingTreeSpecRouteRouteArgs();
    }
}
