...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteMatcherArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteMatcherArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteMatcherArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteArgs>? _routes;

        /// <summary>
        /// Child routes. Each child route has the same schema as `spec.routes` and may be nested up to 5 levels deep.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteArgs Empty => new NotificationsRoutingTreeSpecRouteArgs();
    }
}
