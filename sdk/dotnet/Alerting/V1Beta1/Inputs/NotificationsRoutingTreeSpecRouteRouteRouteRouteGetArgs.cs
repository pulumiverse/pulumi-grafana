...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteRouteRouteRouteGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteMatcherGetArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteMatcherGetArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteMatcherGetArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteRouteGetArgs>? _routes;

        /// <summary>
        /// Child routes of this route.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteRouteGetArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteRouteRouteGetArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteRouteRouteRouteGetArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteRouteRouteRouteGetArgs Empty => new NotificationsRoutingTreeSpecRouteRouteRouteRouteGetArgs();
    }
}
