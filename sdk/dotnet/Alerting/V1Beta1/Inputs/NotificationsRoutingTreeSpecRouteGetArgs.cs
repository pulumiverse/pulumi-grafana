...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteMatcherGetArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteMatcherGetArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteMatcherGetArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteGetArgs>? _routes;

        /// <summary>
        /// Child routes. Each child route has the same schema as `spec.routes` and may be nested up to 5 levels deep.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteGetArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteGetArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteGetArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteGetArgs Empty => new NotificationsRoutingTreeSpecRouteGetArgs();
    }
}
