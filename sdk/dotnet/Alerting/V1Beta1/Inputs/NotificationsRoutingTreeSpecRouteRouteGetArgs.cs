...
namespace Pulumiverse.Grafana.Alerting.V1Beta1.Inputs
{
    ...
    public sealed class NotificationsRoutingTreeSpecRouteRouteGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteMatcherGetArgs>? _matchers;
        ...
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteMatcherGetArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteMatcherGetArgs>());
            set => _matchers = value;
        }
        ...
        [Input("routes")]
        private InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteGetArgs>? _routes;

        /// <summary>
        /// Child routes of this route.
        /// </summary>
        public InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteGetArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.NotificationsRoutingTreeSpecRouteRouteRouteGetArgs>());
            set => _routes = value;
        }

        public NotificationsRoutingTreeSpecRouteRouteGetArgs()
        {
        }
        public static new NotificationsRoutingTreeSpecRouteRouteGetArgs Empty => new NotificationsRoutingTreeSpecRouteRouteGetArgs();
    }
}
