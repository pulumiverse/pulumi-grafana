...
namespace Pulumiverse.Grafana.Alerting.V1Beta1
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:alerting/v1beta1/alertEnrichment:AlertEnrichment")]
    public partial class AlertEnrichment : global::Pulumi.CustomResource
    {
        ...
        public AlertEnrichment(string name, AlertEnrichmentArgs? args = null, CustomResourceOptions? options = null)
            : base("grafana:alerting/v1beta1/alertEnrichment:AlertEnrichment", name, args ?? new AlertEnrichmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertEnrichment(string name, Input<string> id, AlertEnrichmentState? state = null, CustomResourceOptions? options = null)
            : base("grafana:alerting/v1beta1/alertEnrichment:AlertEnrichment", name, state, MakeResourceOptions(options, id))
        {
        }
