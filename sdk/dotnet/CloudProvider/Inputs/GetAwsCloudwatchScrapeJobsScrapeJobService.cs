...
namespace Pulumiverse.Grafana.CloudProvider.Inputs
{
    ...
    public sealed class GetAwsCloudwatchScrapeJobsScrapeJobServiceArgs : global::Pulumi.InvokeArgs
    {
        ...
        {
            get => _metrics ?? (_metrics = new List<Inputs.GetAwsCloudwatchScrapeJobsScrapeJobServiceMetricArgs>());
            set => _metrics = value;
        }
        ...
        private List<Inputs.GetAwsCloudwatchScrapeJobsScrapeJobServiceResourceDiscoveryTagFilterArgs>? _resourceDiscoveryTagFilters;
        ...
        /// </summary>
        public List<Inputs.GetAwsCloudwatchScrapeJobsScrapeJobServiceResourceDiscoveryTagFilterArgs> ResourceDiscoveryTagFilters
        {
            get => _resourceDiscoveryTagFilters ?? (_resourceDiscoveryTagFilters = new List<Inputs.GetAwsCloudwatchScrapeJobsScrapeJobServiceResourceDiscoveryTagFilterArgs>());
        ...
        public GetAwsCloudwatchScrapeJobsScrapeJobServiceArgs()
        {
        }
        public static new GetAwsCloudwatchScrapeJobsScrapeJobServiceArgs Empty => new GetAwsCloudwatchScrapeJobsScrapeJobServiceArgs();
    }
}
