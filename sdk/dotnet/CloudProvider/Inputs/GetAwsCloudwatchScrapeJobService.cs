...
namespace Pulumiverse.Grafana.CloudProvider.Inputs
{
    ...
    public sealed class GetAwsCloudwatchScrapeJobServiceArgs : global::Pulumi.InvokeArgs
    {
        [Input("metrics")]
        private List<Inputs.GetAwsCloudwatchScrapeJobServiceMetricArgs>? _metrics;
        ...
        /// </summary>
        public List<Inputs.GetAwsCloudwatchScrapeJobServiceMetricArgs> Metrics
        {
            get => _metrics ?? (_metrics = new List<Inputs.GetAwsCloudwatchScrapeJobServiceMetricArgs>());
            set => _metrics = value;
        }
        ...
        private List<Inputs.GetAwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs>? _resourceDiscoveryTagFilters;
        ...
        /// </summary>
        public List<Inputs.GetAwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs> ResourceDiscoveryTagFilters
        {
            get => _resourceDiscoveryTagFilters ?? (_resourceDiscoveryTagFilters = new List<Inputs.GetAwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs>());
        ...
        public GetAwsCloudwatchScrapeJobServiceArgs()
        {
        }
        public static new GetAwsCloudwatchScrapeJobServiceArgs Empty => new GetAwsCloudwatchScrapeJobServiceArgs();
    }
}
