...
namespace Pulumiverse.Grafana
{
    ...
    public partial class ConnectionsMetricsEndpointScrapeJob : global::Pulumi.CustomResource
    {
        ...
        public ConnectionsMetricsEndpointScrapeJob(string name, ConnectionsMetricsEndpointScrapeJobArgs args, CustomResourceOptions? options = null)
            : base("grafana:index/connectionsMetricsEndpointScrapeJob:ConnectionsMetricsEndpointScrapeJob", name, args ?? new ConnectionsMetricsEndpointScrapeJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionsMetricsEndpointScrapeJob(string name, Input<string> id, ConnectionsMetricsEndpointScrapeJobState? state = null, CustomResourceOptions? options = null)
            : base("grafana:index/connectionsMetricsEndpointScrapeJob:ConnectionsMetricsEndpointScrapeJob", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConnectionsMetricsEndpointScrapeJob Get(string name, Input<string> id, ConnectionsMetricsEndpointScrapeJobState? state = null, CustomResourceOptions? options = null)
        {
            return new ConnectionsMetricsEndpointScrapeJob(name, id, state, options);
        }
    }

    public sealed class ConnectionsMetricsEndpointScrapeJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public ConnectionsMetricsEndpointScrapeJobArgs()
        {
        }
        public static new ConnectionsMetricsEndpointScrapeJobArgs Empty => new ConnectionsMetricsEndpointScrapeJobArgs();
    }

    public sealed class ConnectionsMetricsEndpointScrapeJobState : global::Pulumi.ResourceArgs
    {
        [Input("authenticationBasicPassword")]
        private Input<string>? _authenticationBasicPassword;
        ...
        public ConnectionsMetricsEndpointScrapeJobState()
        {
        }
        public static new ConnectionsMetricsEndpointScrapeJobState Empty => new ConnectionsMetricsEndpointScrapeJobState();
    }
}
