...
namespace Pulumiverse.Grafana.Apps.V2Beta1
{
    /// <summary>
    ...
    /// {
    ///     var example = new Grafana.Apps.V2Beta1.Dashboard("example", new()
    ///     {
    ///         Metadata = new Grafana.Apps.V2Beta1.Inputs.DashboardMetadataArgs
    ///         {
    ///             Uid = "example-dashboard-v2",
    ///         },
    ///         Spec = new Grafana.Apps.V2Beta1.Inputs.DashboardSpecArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:apps/v2beta1/dashboard:Dashboard")]
    public partial class Dashboard : global::Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs? args = null, CustomResourceOptions? options = null)
            : base("grafana:apps/v2beta1/dashboard:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, DashboardState? state = null, CustomResourceOptions? options = null)
            : base("grafana:apps/v2beta1/dashboard:Dashboard", name, state, MakeResourceOptions(options, id))
        {
        }
