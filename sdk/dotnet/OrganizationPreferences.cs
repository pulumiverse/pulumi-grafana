...
namespace Pulumiverse.Grafana
{
    ...
    /// ```
    /// </summary>
    [Obsolete(@"grafana.index/organizationpreferences.OrganizationPreferences has been deprecated in favor of grafana.oss/organizationpreferences.OrganizationPreferences")]
    [GrafanaResourceType("grafana:index/organizationPreferences:OrganizationPreferences")]
    public partial class OrganizationPreferences : global::Pulumi.CustomResource
    {
        ...
        public OrganizationPreferences(string name, OrganizationPreferencesArgs? args = null, CustomResourceOptions? options = null)
            : base("grafana:index/organizationPreferences:OrganizationPreferences", name, args ?? new OrganizationPreferencesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private OrganizationPreferences(string name, Input<string> id, OrganizationPreferencesState? state = null, CustomResourceOptions? options = null)
            : base("grafana:index/organizationPreferences:OrganizationPreferences", name, state, MakeResourceOptions(options, id))
        {
        }
