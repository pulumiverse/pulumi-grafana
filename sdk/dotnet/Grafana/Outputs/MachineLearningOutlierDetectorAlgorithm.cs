...
namespace Lbrlabs.PulumiPackage.Grafana.Outputs
{
    ...
    [OutputType]
    public sealed class MachineLearningOutlierDetectorAlgorithm
    {
        /// <summary>
        /// For DBSCAN only, specify the configuration map
        /// </summary>
        public readonly Outputs.MachineLearningOutlierDetectorAlgorithmConfig? Config;
        /// <summary>
        ...
        private MachineLearningOutlierDetectorAlgorithm(
            Outputs.MachineLearningOutlierDetectorAlgorithmConfig? config,
