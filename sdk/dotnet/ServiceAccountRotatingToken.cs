...
namespace Pulumiverse.Grafana
{
    ...
    ///     });
    /// 
    ///     var foo = new Grafana.ServiceAccountRotatingToken("foo", new()
    ///     {
    ///         NamePrefix = "key_foo",
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:index/serviceAccountRotatingToken:ServiceAccountRotatingToken")]
    public partial class ServiceAccountRotatingToken : global::Pulumi.CustomResource
    {
        ...
        public ServiceAccountRotatingToken(string name, ServiceAccountRotatingTokenArgs args, CustomResourceOptions? options = null)
            : base("grafana:index/serviceAccountRotatingToken:ServiceAccountRotatingToken", name, args ?? new ServiceAccountRotatingTokenArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ServiceAccountRotatingToken(string name, Input<string> id, ServiceAccountRotatingTokenState? state = null, CustomResourceOptions? options = null)
            : base("grafana:index/serviceAccountRotatingToken:ServiceAccountRotatingToken", name, state, MakeResourceOptions(options, id))
        {
        }
