...
namespace Pulumiverse.Grafana.SyntheticMonitoring.Inputs
{
    ...
    public sealed class CheckSettingsDnsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.CheckSettingsDnsValidateAdditionalRrArgs>? _validateAdditionalRrs;

        /// <summary>
        /// Validate additional matches.
        /// </summary>
        public InputList<Inputs.CheckSettingsDnsValidateAdditionalRrArgs> ValidateAdditionalRrs
        {
            get => _validateAdditionalRrs ?? (_validateAdditionalRrs = new InputList<Inputs.CheckSettingsDnsValidateAdditionalRrArgs>());
        ...
        public Input<Inputs.CheckSettingsDnsValidateAnswerRrsArgs>? ValidateAnswerRrs { get; set; }

        /// <summary>
        /// Validate response authority.
        /// </summary>
        [Input("validateAuthorityRrs")]
        public Input<Inputs.CheckSettingsDnsValidateAuthorityRrsArgs>? ValidateAuthorityRrs { get; set; }

        public CheckSettingsDnsArgs()
        {
        }
        public static new CheckSettingsDnsArgs Empty => new CheckSettingsDnsArgs();
    }
}
