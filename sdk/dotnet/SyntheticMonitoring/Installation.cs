...
namespace Pulumiverse.Grafana.SyntheticMonitoring
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:syntheticMonitoring/installation:Installation")]
    public partial class Installation : global::Pulumi.CustomResource
    {
        ...
        public Installation(string name, InstallationArgs args, CustomResourceOptions? options = null)
            : base("grafana:syntheticMonitoring/installation:Installation", name, args ?? new InstallationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Installation(string name, Input<string> id, InstallationState? state = null, CustomResourceOptions? options = null)
            : base("grafana:syntheticMonitoring/installation:Installation", name, state, MakeResourceOptions(options, id))
        {
        }
