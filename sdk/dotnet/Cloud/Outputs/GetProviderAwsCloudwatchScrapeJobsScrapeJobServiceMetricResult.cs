...
namespace Pulumiverse.Grafana.Cloud.Outputs
{
    ...
    [OutputType]
    public sealed class GetProviderAwsCloudwatchScrapeJobsScrapeJobServiceMetricResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetProviderAwsCloudwatchScrapeJobsScrapeJobServiceMetricResult(
            string name,
