...
namespace Pulumiverse.Grafana.Cloud
{
    ...
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:cloud/accessPolicyToken:AccessPolicyToken")]
    public partial class AccessPolicyToken : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AccessPolicyToken(string name, AccessPolicyTokenArgs args, CustomResourceOptions? options = null)
            : base("grafana:cloud/accessPolicyToken:AccessPolicyToken", name, args ?? new AccessPolicyTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyToken(string name, Input<string> id, AccessPolicyTokenState? state = null, CustomResourceOptions? options = null)
            : base("grafana:cloud/accessPolicyToken:AccessPolicyToken", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccessPolicyToken Get(string name, Input<string> id, AccessPolicyTokenState? state = null, CustomResourceOptions? options = null)
        {
            return new AccessPolicyToken(name, id, state, options);
        }
    }

    public sealed class AccessPolicyTokenArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// ID of the access policy for which to create a token.
        /// </summary>
        ...
        public AccessPolicyTokenArgs()
        {
        }
        public static new AccessPolicyTokenArgs Empty => new AccessPolicyTokenArgs();
    }

    public sealed class AccessPolicyTokenState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// ID of the access policy for which to create a token.
        /// </summary>
        ...
        public AccessPolicyTokenState()
        {
        }
        public static new AccessPolicyTokenState Empty => new AccessPolicyTokenState();
    }
}
