...
namespace Pulumiverse.Grafana.Cloud.Inputs
{
    ...
    public sealed class GetProviderAwsCloudwatchScrapeJobsScrapeJobArgs : global::Pulumi.InvokeArgs
    {
        ...
        private List<Inputs.GetProviderAwsCloudwatchScrapeJobsScrapeJobCustomNamespaceArgs>? _customNamespaces;
        ...
        /// </summary>
        public List<Inputs.GetProviderAwsCloudwatchScrapeJobsScrapeJobCustomNamespaceArgs> CustomNamespaces
        {
            get => _customNamespaces ?? (_customNamespaces = new List<Inputs.GetProviderAwsCloudwatchScrapeJobsScrapeJobCustomNamespaceArgs>());
        ...
        [Input("services")]
        private List<Inputs.GetProviderAwsCloudwatchScrapeJobsScrapeJobServiceArgs>? _services;
        ...
        /// </summary>
        public List<Inputs.GetProviderAwsCloudwatchScrapeJobsScrapeJobServiceArgs> Services
        {
            get => _services ?? (_services = new List<Inputs.GetProviderAwsCloudwatchScrapeJobsScrapeJobServiceArgs>());
            set => _services = value;
        }
        ...
        public static new GetProviderAwsCloudwatchScrapeJobsScrapeJobArgs Empty => new GetProviderAwsCloudwatchScrapeJobsScrapeJobArgs();
    }
}
