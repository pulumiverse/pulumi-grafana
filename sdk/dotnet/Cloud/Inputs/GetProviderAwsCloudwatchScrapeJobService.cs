...
namespace Pulumiverse.Grafana.Cloud.Inputs
{
    ...
    public sealed class GetProviderAwsCloudwatchScrapeJobServiceArgs : global::Pulumi.InvokeArgs
    {
        [Input("metrics")]
        private List<Inputs.GetProviderAwsCloudwatchScrapeJobServiceMetricArgs>? _metrics;
        ...
        /// </summary>
        public List<Inputs.GetProviderAwsCloudwatchScrapeJobServiceMetricArgs> Metrics
        {
            get => _metrics ?? (_metrics = new List<Inputs.GetProviderAwsCloudwatchScrapeJobServiceMetricArgs>());
            set => _metrics = value;
        }
        ...
        private List<Inputs.GetProviderAwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs>? _resourceDiscoveryTagFilters;
        ...
        /// </summary>
        public List<Inputs.GetProviderAwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs> ResourceDiscoveryTagFilters
        {
            get => _resourceDiscoveryTagFilters ?? (_resourceDiscoveryTagFilters = new List<Inputs.GetProviderAwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs>());
        ...
        public GetProviderAwsCloudwatchScrapeJobServiceArgs()
        {
        }
        public static new GetProviderAwsCloudwatchScrapeJobServiceArgs Empty => new GetProviderAwsCloudwatchScrapeJobServiceArgs();
    }
}
