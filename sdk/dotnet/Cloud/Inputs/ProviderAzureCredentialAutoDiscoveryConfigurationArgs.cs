...
namespace Pulumiverse.Grafana.Cloud.Inputs
{
    ...
    public sealed class ProviderAzureCredentialAutoDiscoveryConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ProviderAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs>? _resourceTypeConfigurations;

        /// <summary>
        /// The list of resource type configurations.
        /// </summary>
        public InputList<Inputs.ProviderAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs> ResourceTypeConfigurations
        {
            get => _resourceTypeConfigurations ?? (_resourceTypeConfigurations = new InputList<Inputs.ProviderAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs>());
