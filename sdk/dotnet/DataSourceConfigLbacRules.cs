...
namespace Pulumiverse.Grafana
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import grafana:index/dataSourceConfigLbacRules:DataSourceConfigLbacRules name "{{ datasource_uid }}"
    /// ```
    /// </summary>
    [GrafanaResourceType("grafana:index/dataSourceConfigLbacRules:DataSourceConfigLbacRules")]
    public partial class DataSourceConfigLbacRules : global::Pulumi.CustomResource
    {
        ...
        public DataSourceConfigLbacRules(string name, DataSourceConfigLbacRulesArgs args, CustomResourceOptions? options = null)
            : base("grafana:index/dataSourceConfigLbacRules:DataSourceConfigLbacRules", name, args ?? new DataSourceConfigLbacRulesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DataSourceConfigLbacRules(string name, Input<string> id, DataSourceConfigLbacRulesState? state = null, CustomResourceOptions? options = null)
            : base("grafana:index/dataSourceConfigLbacRules:DataSourceConfigLbacRules", name, state, MakeResourceOptions(options, id))
        {
        }
