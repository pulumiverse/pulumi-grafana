...
class MuteTimingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disable_provenance: Allow modifying the mute timing from other sources than Terraform or the Grafana API. Defaults to `false`.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the mute timing.
...
@pulumi.type_token("grafana:alerting/muteTiming:MuteTiming")
class MuteTiming(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            intervals: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MuteTimingIntervalArgs', 'MuteTimingIntervalArgsDict']]]]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            org_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'MuteTiming':
        """
