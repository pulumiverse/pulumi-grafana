...
class PrivateDataSourceConnectNetworkArgs:
    def __init__(__self__, *,
                 ...
                 stack_identifier: pulumi.Input[builtins.str],
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PrivateDataSourceConnectNetwork resource.
        :param pulumi.Input[builtins.str] region: The region where your stack is deployed. Use the instances list API to get the region for your instance - use the regionSlug property: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-stacks
        :param pulumi.Input[builtins.str] stack_identifier: The identifier of the stack.
        :param pulumi.Input[builtins.str] display_name: Display name of the PDC network. Defaults to the name.
        :param pulumi.Input[builtins.str] name: Name of the PDC network.**Note:** The name must be lowercase and can contain hyphens or underscores. See full requirements here: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#request-body
        """
    ...
    def stack_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stack_identifier(self, value: pulumi.Input[builtins.str]):
...
class _PrivateDataSourceConnectNetworkState:
    def __init__(__self__, *,
                 ...
                 stack_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 updated_at: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering PrivateDataSourceConnectNetwork resources.
        :param pulumi.Input[builtins.str] created_at: Creation date of the private data source connect network.
        :param pulumi.Input[builtins.str] display_name: Display name of the PDC network. Defaults to the name.
        :param pulumi.Input[builtins.str] name: Name of the PDC network.**Note:** The name must be lowercase and can contain hyphens or underscores. See full requirements here: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#request-body
        :param pulumi.Input[builtins.str] pdc_network_id: ID of the private data source connect network.
        :param pulumi.Input[builtins.str] region: The region where your stack is deployed. Use the instances list API to get the region for your instance - use the regionSlug property: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-stacks
        :param pulumi.Input[builtins.str] stack_identifier: The identifier of the stack.
        :param pulumi.Input[builtins.str] updated_at: Last update date of the private data source connect network.
        """
    ...
    @property
    @pulumi.getter(name="stackIdentifier")
    def stack_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the stack.
        """
        return pulumi.get(self, "stack_identifier")
    ...
    @stack_identifier.setter
    def stack_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stack_identifier", value)
...
class PrivateDataSourceConnectNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            stack_identifier: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateDataSourceConnectNetwork':
        """
    ...
    @property
    @pulumi.getter(name="stackIdentifier")
    def stack_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The identifier of the stack.
        """
        return pulumi.get(self, "stack_identifier")
