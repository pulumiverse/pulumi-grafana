...
class ProductActivationAppO11yConfigV1Alpha1Options(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProductActivationAppO11yConfigV1Alpha1Options. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProductActivationAppO11yConfigV1Alpha1Options.__key_warning(key)
        return super().__getitem__(key)
...
class ProductActivationK8sO11yConfigV1Alpha1Options(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProductActivationK8sO11yConfigV1Alpha1Options. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProductActivationK8sO11yConfigV1Alpha1Options.__key_warning(key)
        return super().__getitem__(key)
