...
class GetPrivateDataSourceConnectNetworksResult:
    ...
    def region_filter(self) -> Optional[builtins.str]:
...
def get_private_data_source_connect_networks(name_filter: Optional[builtins.str] = None,
                                             region_filter: Optional[builtins.str] = None,
...
def get_private_data_source_connect_networks_output(name_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    region_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
