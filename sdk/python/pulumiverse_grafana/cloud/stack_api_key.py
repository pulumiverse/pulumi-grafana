...
__all__ = ['StackApiKeyArgs', 'StackApiKey']

@pulumi.input_type
class StackApiKeyArgs:
...
class StackApiKey(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a StackApiKey resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: StackApiKeyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a StackApiKey resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param StackApiKeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StackApiKeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StackApiKeyArgs.__new__(StackApiKeyArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="grafana:index/cloudStackApiKey:CloudStackApiKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["key"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(StackApiKey, __self__).__init__(
            'grafana:cloud/stackApiKey:StackApiKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[str]] = None,
            seconds_to_live: Optional[pulumi.Input[int]] = None,
            stack_slug: Optional[pulumi.Input[str]] = None) -> 'StackApiKey':
        """
        ...
        __props__ = _StackApiKeyState.__new__(_StackApiKeyState)
        ...
        __props__.__dict__["seconds_to_live"] = seconds_to_live
        __props__.__dict__["stack_slug"] = stack_slug
        return StackApiKey(resource_name, opts=opts, __props__=__props__)
