...
class PrivateDataSourceConnectNetworkTokenArgs:
    def __init__(__self__, *,
                 pdc_network_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] name: Name of the private data source network token.
        """
    ...
    def pdc_network_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def pdc_network_id(self, value: pulumi.Input[_builtins.str]):
...
class _PrivateDataSourceConnectNetworkTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] pdc_network_id: ID of the private data source network for which to create a token.
        :param pulumi.Input[_builtins.str] region: Region of the private data source network. Should be set to the same region as the private data source network. Use the region list API to get the list of available regions: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-regions.
        :param pulumi.Input[_builtins.str] updated_at: Last update date of the private data source network token.
        """
...
class PrivateDataSourceConnectNetworkToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'PrivateDataSourceConnectNetworkToken':
        """
