...
class OrgMemberArgs:
    ...
    def receive_billing_emails(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def receive_billing_emails(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class OrgMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            receive_billing_emails: Optional[pulumi.Input[_builtins.bool]] = None,
            role: Optional[pulumi.Input[_builtins.str]] = None,
            user: Optional[pulumi.Input[_builtins.str]] = None) -> 'OrgMember':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="receiveBillingEmails")
    def receive_billing_emails(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether the user should receive billing emails.
        """
        return pulumi.get(self, "receive_billing_emails")
