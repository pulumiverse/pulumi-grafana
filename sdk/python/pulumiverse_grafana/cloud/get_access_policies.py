...
def get_access_policies(name_filter: Optional[_builtins.str] = None,
...
def get_access_policies_output(name_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
