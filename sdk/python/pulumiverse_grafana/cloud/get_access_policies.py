...
def get_access_policies(name_filter: Optional[builtins.str] = None,
...
def get_access_policies_output(name_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
