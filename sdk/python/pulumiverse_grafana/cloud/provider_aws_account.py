...
class ProviderAwsAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: A set of regions that this AWS Account resource applies to.
        :param pulumi.Input[builtins.str] role_arn: An IAM Role ARN string to represent with this AWS Account resource.
        :param pulumi.Input[builtins.str] name: An optional human-readable name for this AWS Account resource.
        """
...
class _ProviderAwsAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: An optional human-readable name for this AWS Account resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: A set of regions that this AWS Account resource applies to.
        :param pulumi.Input[builtins.str] resource_id: The ID given by the Grafana Cloud Provider API to this AWS Account resource.
        :param pulumi.Input[builtins.str] role_arn: An IAM Role ARN string to represent with this AWS Account resource.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
@pulumi.type_token("grafana:cloud/providerAwsAccount:ProviderAwsAccount")
class ProviderAwsAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_id: Optional[pulumi.Input[builtins.str]] = None,
            role_arn: Optional[pulumi.Input[builtins.str]] = None,
            stack_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ProviderAwsAccount':
        """
