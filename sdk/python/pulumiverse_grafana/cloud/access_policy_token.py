...
class AccessPolicyTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expires_at: Expiration date of the access policy token. Does not expire by default.
...
class AccessPolicyToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'AccessPolicyToken':
        """
