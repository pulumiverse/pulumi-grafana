...
__all__ = ['AccessPolicyTokenArgs', 'AccessPolicyToken']

@pulumi.input_type
class AccessPolicyTokenArgs:
    def __init__(__self__, *,
                 access_policy_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] access_policy_id: ID of the access policy for which to create a token.
        :param pulumi.Input[builtins.str] region: Region of the access policy. Should be set to the same region as the access policy. Use the region list API to get the list of available regions: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-regions.
        :param pulumi.Input[builtins.str] display_name: Display name of the access policy token. Defaults to the name.
        :param pulumi.Input[builtins.str] expires_at: Expiration date of the access policy token. Does not expire by default.
        :param pulumi.Input[builtins.str] name: Name of the access policy token.
        """
    ...
    def access_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_policy_id(self, value: pulumi.Input[builtins.str]):
...
class _AccessPolicyTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_policy_id: ID of the access policy for which to create a token.
        :param pulumi.Input[builtins.str] created_at: Creation date of the access policy token.
        :param pulumi.Input[builtins.str] display_name: Display name of the access policy token. Defaults to the name.
        :param pulumi.Input[builtins.str] expires_at: Expiration date of the access policy token. Does not expire by default.
        :param pulumi.Input[builtins.str] name: Name of the access policy token.
        :param pulumi.Input[builtins.str] region: Region of the access policy. Should be set to the same region as the access policy. Use the region list API to get the list of available regions: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-regions.
        :param pulumi.Input[builtins.str] updated_at: Last update date of the access policy token.
        """
...
@pulumi.type_token("grafana:cloud/accessPolicyToken:AccessPolicyToken")
class AccessPolicyToken(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AccessPolicyTokenArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AccessPolicyTokenArgs.__new__(AccessPolicyTokenArgs)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessPolicyToken':
        """
        ...
        __props__ = _AccessPolicyTokenState.__new__(_AccessPolicyTokenState)
        ...
        return AccessPolicyToken(resource_name, opts=opts, __props__=__props__)
