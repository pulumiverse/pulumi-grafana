...
class OncallUserNotificationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Note**: you must be running Grafana OnCall >= v1.8.0 to use this resource.
        ...
        my_user_step1 = grafana.OncallUserNotificationRule("myUserStep1",
            user_id=my_user.id,
            position=0,
            type="notify_by_mobile_app",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_step2 = grafana.OncallUserNotificationRule("myUserStep2",
            user_id=my_user.id,
            position=1,
            duration=600,
            type="wait",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_step3 = grafana.OncallUserNotificationRule("myUserStep3",
            user_id=my_user.id,
            position=2,
            type="notify_by_phone_call",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_step4 = grafana.OncallUserNotificationRule("myUserStep4",
            user_id=my_user.id,
            position=3,
            duration=300,
            type="wait",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_step5 = grafana.OncallUserNotificationRule("myUserStep5",
            user_id=my_user.id,
            position=4,
            type="notify_by_slack",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_important_step1 = grafana.OncallUserNotificationRule("myUserImportantStep1",
            user_id=my_user.id,
            important=True,
            position=0,
            type="notify_by_mobile_app_critical",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_important_step2 = grafana.OncallUserNotificationRule("myUserImportantStep2",
            user_id=my_user.id,
            important=True,
            position=1,
            duration=300,
            type="wait",
            opts=pulumi.ResourceOptions(provider=grafana["oncall"]))
        my_user_important_step3 = grafana.OncallUserNotificationRule("myUserImportantStep3",
            user_id=my_user.id,
            important=True,
            position=2,
            type="notify_by_mobile_app_critical",
