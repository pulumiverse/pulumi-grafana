...
class RoleArgs:
    def __init__(__self__, *,
                 auto_increment_version: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] group: Group of the role. Available with Grafana 8.5+.
        :param pulumi.Input[_builtins.bool] hidden: Boolean to state whether the role should be visible in the Grafana UI or not. Available with Grafana 8.5+. Defaults to `false`.
        ...
        :param pulumi.Input[_builtins.int] version: Version of the role. A role is updated only on version increase. This field or `auto_increment_version` should be set.
        """
    ...
    def auto_increment_version(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class Role(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            permissions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RolePermissionArgs', 'RolePermissionArgsDict']]]]] = None,
            uid: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.int]] = None) -> 'Role':
        """
