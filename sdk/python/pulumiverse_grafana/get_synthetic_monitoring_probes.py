...
class GetSyntheticMonitoringProbesResult:
    ...
    def filter_deprecated(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def probes(self) -> Mapping[str, builtins.int]:
        """
...
def get_synthetic_monitoring_probes(filter_deprecated: Optional[builtins.bool] = None,
    ...
    :param builtins.bool filter_deprecated: If true, only probes that are not deprecated will be returned. Defaults to `true`.
    """
...
def get_synthetic_monitoring_probes_output(filter_deprecated: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
