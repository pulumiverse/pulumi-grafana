...
@pulumi.type_token("grafana:index/syntheticMonitoringCheck:SyntheticMonitoringCheck")
class SyntheticMonitoringCheck(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.int]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'SyntheticMonitoringCheck':
        """
