...
def get_oncall_escalation_chain(name: Optional[builtins.str] = None,
    ...
    * [HTTP API](https://grafana.com/docs/oncall/latest/oncall-api-reference/escalation_chains/)
    ...
    :param builtins.str name: The escalation chain name.
    """
...
def get_oncall_escalation_chain_output(name: Optional[pulumi.Input[builtins.str]] = None,
