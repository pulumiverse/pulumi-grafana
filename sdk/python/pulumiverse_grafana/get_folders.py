...
warnings.warn("""grafana.index/getfolders.getFolders has been deprecated in favor of grafana.oss/getfolders.getFolders""", DeprecationWarning)
...
def get_folders(org_id: Optional[builtins.str] = None,
...
def get_folders_output(org_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    * [HTTP API](https://grafana.com/docs/grafana/latest/developers/http_api/folder/)
    ...
    __ret__ = pulumi.runtime.invoke_output('grafana:index/getFolders:getFolders', __args__, opts=opts, typ=GetFoldersResult)
