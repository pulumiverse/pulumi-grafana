...
class PlaylistArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the playlist.
...
@pulumi.type_token("grafana:index/playlist:Playlist")
class Playlist(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            items: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PlaylistItemArgs', 'PlaylistItemArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            org_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Playlist':
        """
