...
class GetProbeResult:
    ...
    def disable_browser_checks(self) -> _builtins.bool:
        """
    ...
    def disable_scripted_checks(self) -> _builtins.bool:
        """
...
def get_probe(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of the probe.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_probe_output(name: Optional[pulumi.Input[_builtins.str]] = None,
