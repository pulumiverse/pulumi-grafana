...
class CheckSettingsDns(dict):
    ...
    def __init__(__self__, *,
                 ...
                 valid_r_codes: Optional[Sequence[_builtins.str]] = None,
        ...
        """
        :param _builtins.str ip_version: Options are `V4`, `V6`, `Any`. Specifies whether the corresponding check will be performed using IPv4 or IPv6. The `Any` value indicates that IPv6 should be used, falling back to IPv4 if that's not available. Defaults to `V4`.
        :param _builtins.int port: Port to target. Defaults to `53`.
        :param _builtins.str protocol: `TCP` or `UDP`. Defaults to `UDP`.
        :param _builtins.str record_type: One of `ANY`, `A`, `AAAA`, `CNAME`, `MX`, `NS`, `PTR`, `SOA`, `SRV`, `TXT`. Defaults to `A`.
        :param _builtins.str server: DNS server address to target. Defaults to `8.8.8.8`.
        :param _builtins.str source_ip_address: Source IP address.
        :param Sequence[_builtins.str] valid_r_codes: List of valid response codes. Options include `NOERROR`, `BADALG`, `BADMODE`, `BADKEY`, `BADCOOKIE`, `BADNAME`, `BADSIG`, `BADTIME`, `BADTRUNC`, `BADVERS`, `FORMERR`, `NOTIMP`, `NOTAUTH`, `NOTZONE`, `NXDOMAIN`, `NXRRSET`, `REFUSED`, `SERVFAIL`, `YXDOMAIN`, `YXRRSET`.
    ...
    def valid_r_codes(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class CheckSettingsDnsValidateAdditionalRr(dict):
    ...
    def __init__(__self__, *,
                 fail_if_matches_regexps: Optional[Sequence[_builtins.str]] = None,
                 fail_if_not_matches_regexps: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] fail_if_matches_regexps: Fail if value matches regex.
        :param Sequence[_builtins.str] fail_if_not_matches_regexps: Fail if value does not match regex.
        """
    ...
    def fail_if_matches_regexps(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def fail_if_not_matches_regexps(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class CheckSettingsGrpc(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ip_version: Options are `V4`, `V6`, `Any`. Specifies whether the corresponding check will be performed using IPv4 or IPv6. The `Any` value indicates that IPv6 should be used, falling back to IPv4 if that's not available. Defaults to `V4`.
        :param _builtins.str service: gRPC service.
        :param _builtins.bool tls: Whether or not TLS is used when the connection is initiated. Defaults to `false`.
...
class CheckSettingsGrpcTlsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ca_cert: CA certificate in PEM format.
        :param _builtins.str client_cert: Client certificate in PEM format.
        :param _builtins.str client_key: Client key in PEM format.
        :param _builtins.bool insecure_skip_verify: Disable target certificate validation. Defaults to `false`.
        :param _builtins.str server_name: Used to verify the hostname for the targets.
        """
...
class CheckSettingsHttp(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "basicAuth":
            ...
            suggest = "proxy_url"
        elif key == "secretManagerEnabled":
            suggest = "secret_manager_enabled"
        elif key == "tlsConfig":
            suggest = "tls_config"
    ...
    def __init__(__self__, *,
                 ...
                 cache_busting_query_param_name: Optional[_builtins.str] = None,
                 compression: Optional[_builtins.str] = None,
                 fail_if_body_matches_regexps: Optional[Sequence[_builtins.str]] = None,
                 fail_if_body_not_matches_regexps: Optional[Sequence[_builtins.str]] = None,
                 ...
                 fail_if_not_ssl: Optional[_builtins.bool] = None,
                 fail_if_ssl: Optional[_builtins.bool] = None,
                 headers: Optional[Sequence[_builtins.str]] = None,
                 ip_version: Optional[_builtins.str] = None,
                 method: Optional[_builtins.str] = None,
                 no_follow_redirects: Optional[_builtins.bool] = None,
                 proxy_connect_headers: Optional[Sequence[_builtins.str]] = None,
                 proxy_url: Optional[_builtins.str] = None,
                 secret_manager_enabled: Optional[_builtins.bool] = None,
                 tls_config: Optional['outputs.CheckSettingsHttpTlsConfig'] = None,
                 valid_http_versions: Optional[Sequence[_builtins.str]] = None,
                 valid_status_codes: Optional[Sequence[_builtins.int]] = None):
        """
        :param 'CheckSettingsHttpBasicAuthArgs' basic_auth: Basic auth settings.
        :param _builtins.str bearer_token: Token for use with bearer authorization header.
        :param _builtins.str body: The body of the HTTP request used in probe.
        :param _builtins.str cache_busting_query_param_name: The name of the query parameter used to prevent the server from using a cached response. Each probe will assign a random value to this parameter each time a request is made.
        :param _builtins.str compression: Check fails if the response body is not compressed using this compression algorithm. One of `none`, `identity`, `br`, `gzip`, `deflate`.
        :param Sequence[_builtins.str] fail_if_body_matches_regexps: List of regexes. If any match the response body, the check will fail.
        :param Sequence[_builtins.str] fail_if_body_not_matches_regexps: List of regexes. If any do not match the response body, the check will fail.
        ...
        :param _builtins.bool fail_if_not_ssl: Fail if SSL is not present. Defaults to `false`.
        :param _builtins.bool fail_if_ssl: Fail if SSL is present. Defaults to `false`.
        :param Sequence[_builtins.str] headers: The HTTP headers set for the probe.
        :param _builtins.str ip_version: Options are `V4`, `V6`, `Any`. Specifies whether the corresponding check will be performed using IPv4 or IPv6. The `Any` value indicates that IPv6 should be used, falling back to IPv4 if that's not available. Defaults to `V4`.
        :param _builtins.str method: Request method. One of `GET`, `CONNECT`, `DELETE`, `HEAD`, `OPTIONS`, `POST`, `PUT`, `TRACE` Defaults to `GET`.
        :param _builtins.bool no_follow_redirects: Do not follow redirects. Defaults to `false`.
        :param Sequence[_builtins.str] proxy_connect_headers: The HTTP headers sent to the proxy URL
        :param _builtins.str proxy_url: Proxy URL.
        :param _builtins.bool secret_manager_enabled: Enable secret manager so that `${secrets.<name>}` references in the bearer token, basic auth password, and TLS certificate/key fields are resolved from Grafana Secrets Manager at check time. In Terraform HCL, escape the leading `$` (`$${secrets.<name>}`) so the reference is passed through literally rather than interpolated by Terraform. All probes assigned to the check must support protocol secrets, otherwise the API rejects the check. Defaults to `false`.
        :param 'CheckSettingsHttpTlsConfigArgs' tls_config: TLS config.
        :param Sequence[_builtins.str] valid_http_versions: List of valid HTTP versions. Options include `HTTP/1.0`, `HTTP/1.1`, `HTTP/2.0`
        :param Sequence[_builtins.int] valid_status_codes: Accepted status codes. If unset, defaults to 2xx.
        """
    ...
    def cache_busting_query_param_name(self) -> Optional[_builtins.str]:
        """
    ...
    def fail_if_body_matches_regexps(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def fail_if_body_not_matches_regexps(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def fail_if_not_ssl(self) -> Optional[_builtins.bool]:
        """
    ...
    def fail_if_ssl(self) -> Optional[_builtins.bool]:
        """
    ...
    def no_follow_redirects(self) -> Optional[_builtins.bool]:
        """
    ...
    def proxy_connect_headers(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def secret_manager_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def valid_http_versions(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def valid_status_codes(self) -> Optional[Sequence[_builtins.int]]:
        """
...
class CheckSettingsHttpBasicAuth(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str password: Basic auth password.
        :param _builtins.str username: Basic auth username.
        """
...
class CheckSettingsHttpFailIfHeaderMatchesRegexp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_missing: Optional[_builtins.bool] = None):
        """
        :param _builtins.str header: Header name.
        :param _builtins.str regexp: Regex that header value should match.
        :param _builtins.bool allow_missing: Allow header to be missing from responses. Defaults to `false`.
        """
    ...
    def allow_missing(self) -> Optional[_builtins.bool]:
        """
...
class CheckSettingsMultihttpEntryAssertion(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The type of assertion to make: TEXT, JSON*PATH*VALUE, JSON*PATH*ASSERTION, REGEX_ASSERTION
        :param _builtins.str condition: The condition of the assertion: NOT*CONTAINS, EQUALS, STARTS*WITH, ENDS*WITH, TYPE*OF, CONTAINS
        :param _builtins.str expression: The expression of the assertion. Should start with $.
        :param _builtins.str subject: The subject of the assertion: RESPONSE*HEADERS, HTTP*STATUS*CODE, RESPONSE*BODY
        :param _builtins.str value: The value of the assertion
        """
...
class CheckSettingsMultihttpEntryRequest(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str url: The URL for the request
...
class CheckSettingsMultihttpEntryRequestBody(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str content_encoding: The content encoding of the body
        :param _builtins.str content_type: The content type of the body
        :param _builtins.str payload: The body payload
        """
...
class CheckSettingsMultihttpEntryRequestHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str name: Name of the header to send
        :param _builtins.str value: Value of the header to send
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class CheckSettingsMultihttpEntryRequestQueryField(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str name: Name of the query field to send
        :param _builtins.str value: Value of the query field to send
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class CheckSettingsMultihttpEntryVariable(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The method of finding the variable value to extract. JSON*PATH, REGEX, CSS*SELECTOR
        :param _builtins.str attribute: The attribute to use when finding the variable value. Only used when type is CSS_SELECTOR
        :param _builtins.str expression: The expression to when finding the variable. Should start with $. Only use when type is JSON_PATH or REGEX
        :param _builtins.str name: The name of the variable to extract
        """
        pulumi.set(__self__, "type", type)
...
class CheckSettingsPing(dict):
    ...
    def __init__(__self__, *,
                 dont_fragment: Optional[_builtins.bool] = None,
                 ip_version: Optional[_builtins.str] = None,
                 payload_size: Optional[_builtins.int] = None,
                 source_ip_address: Optional[_builtins.str] = None):
        """
        :param _builtins.bool dont_fragment: Set the DF-bit in the IP-header. Only works with ipV4. Defaults to `false`.
        :param _builtins.str ip_version: Options are `V4`, `V6`, `Any`. Specifies whether the corresponding check will be performed using IPv4 or IPv6. The `Any` value indicates that IPv6 should be used, falling back to IPv4 if that's not available. Defaults to `V4`.
        :param _builtins.int payload_size: Payload size. Defaults to `0`.
        :param _builtins.str source_ip_address: Source IP address.
        """
    ...
    def dont_fragment(self) -> Optional[_builtins.bool]:
        """
    ...
    def payload_size(self) -> Optional[_builtins.int]:
        """
...
class CheckSettingsTcpQueryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str expect: Response to expect.
        :param _builtins.str send: Data to send.
        :param _builtins.bool start_tls: Upgrade TCP connection to TLS. Defaults to `false`.
        """
...
class CheckSettingsTraceroute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_unknown_hops: Optional[_builtins.int] = None,
                 ptr_lookup: Optional[_builtins.bool] = None):
        """
        :param _builtins.int max_hops: Maximum TTL for the trace Defaults to `64`.
        :param _builtins.int max_unknown_hops: Maximum number of hosts to travers that give no response Defaults to `15`.
        :param _builtins.bool ptr_lookup: Reverse lookup hostnames from IP addresses Defaults to `true`.
        """
    ...
    def max_unknown_hops(self) -> Optional[_builtins.int]:
        """
    ...
    def ptr_lookup(self) -> Optional[_builtins.bool]:
        """
