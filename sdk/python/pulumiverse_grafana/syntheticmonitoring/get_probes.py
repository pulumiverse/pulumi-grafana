...
class GetProbesResult:
    ...
    def filter_deprecated(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def probes(self) -> Mapping[str, _builtins.int]:
        """
...
def get_probes(filter_deprecated: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool filter_deprecated: If true, only probes that are not deprecated will be returned. Defaults to `true`.
    """
    __args__ = dict()
...
def get_probes_output(filter_deprecated: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
