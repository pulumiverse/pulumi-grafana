...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 cloud_api_url: Optional[pulumi.Input[_builtins.str]] = None,
                 cloud_provider_access_token: Optional[pulumi.Input[_builtins.str]] = None,
                 cloud_provider_url: Optional[pulumi.Input[_builtins.str]] = None,
                 connections_api_access_token: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 k6_url: Optional[pulumi.Input[_builtins.str]] = None,
                 oncall_access_token: Optional[pulumi.Input[_builtins.str]] = None,
                 oncall_url: Optional[pulumi.Input[_builtins.str]] = None,
                 org_id: Optional[pulumi.Input[_builtins.int]] = None,
                 retries: Optional[pulumi.Input[_builtins.int]] = None,
                 retry_status_codes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 retry_wait: Optional[pulumi.Input[_builtins.int]] = None,
                 sm_access_token: Optional[pulumi.Input[_builtins.str]] = None,
                 sm_url: Optional[pulumi.Input[_builtins.str]] = None,
                 stack_id: Optional[pulumi.Input[_builtins.int]] = None,
                 store_dashboard_sha256: Optional[pulumi.Input[_builtins.bool]] = None,
                 tls_cert: Optional[pulumi.Input[_builtins.str]] = None,
                 tls_key: Optional[pulumi.Input[_builtins.str]] = None,
                 url: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.

        :param pulumi.Input[_builtins.str] auth: API token, basic auth in the `username:password` format or `anonymous` (string literal). May alternatively be set via the `GRAFANA_AUTH` environment variable.
        :param pulumi.Input[_builtins.str] ca_cert: Certificate CA bundle (file path or literal value) to use to verify the Grafana server's certificate. May alternatively be set via the `GRAFANA_CA_CERT` environment variable.
        :param pulumi.Input[_builtins.str] cloud_access_policy_token: Access Policy Token for Grafana Cloud. May alternatively be set via the `GRAFANA_CLOUD_ACCESS_POLICY_TOKEN` environment variable.
        :param pulumi.Input[_builtins.str] cloud_api_url: Grafana Cloud's API URL. May alternatively be set via the `GRAFANA_CLOUD_API_URL` environment variable.
        :param pulumi.Input[_builtins.str] cloud_provider_access_token: A Grafana Cloud Provider access token. May alternatively be set via the `GRAFANA_CLOUD_PROVIDER_ACCESS_TOKEN` environment variable.
        :param pulumi.Input[_builtins.str] cloud_provider_url: A Grafana Cloud Provider backend address. May alternatively be set via the `GRAFANA_CLOUD_PROVIDER_URL` environment variable.
        :param pulumi.Input[_builtins.str] connections_api_access_token: A Grafana Connections API access token. May alternatively be set via the `GRAFANA_CONNECTIONS_API_ACCESS_TOKEN` environment variable.
        :param pulumi.Input[_builtins.str] connections_api_url: A Grafana Connections API address. May alternatively be set via the `GRAFANA_CONNECTIONS_API_URL` environment variable.
        ...
        :param pulumi.Input[_builtins.int] retry_wait: The amount of time in seconds to wait between retries for Grafana API and Grafana Cloud API calls. May alternatively be set via the `GRAFANA_RETRY_WAIT` environment variable.
        :param pulumi.Input[_builtins.str] sm_access_token: A Synthetic Monitoring access token. May alternatively be set via the `GRAFANA_SM_ACCESS_TOKEN` environment variable.
        :param pulumi.Input[_builtins.str] sm_url: Synthetic monitoring backend address. May alternatively be set via the `GRAFANA_SM_URL` environment variable. The correct value for each service region is cited in the [Synthetic Monitoring documentation](https://grafana.com/docs/grafana-cloud/testing/synthetic-monitoring/set-up/set-up-private-probes/#probe-api-server-url). Note the `sm_url` value is optional, but it must correspond with the value specified as the `region_slug` in the `cloud.Stack` resource. Also note that when a Terraform configuration contains multiple provider instances managing SM resources associated with the same Grafana stack, specifying an explicit `sm_url` set to the same value for each provider ensures all providers interact with the same SM API.
        :param pulumi.Input[_builtins.int] stack_id: The Grafana stack ID, if you are using a Grafana Cloud stack. May alternatively be set via the `GRAFANA_STACK_ID` environment variable.
        :param pulumi.Input[_builtins.bool] store_dashboard_sha256: Set to true if you want to save only the sha256sum instead of complete dashboard model JSON in the tfstate.
        :param pulumi.Input[_builtins.str] tls_cert: Client TLS certificate (file path or literal value) to use to authenticate to the Grafana server. May alternatively be set via the `GRAFANA_TLS_CERT` environment variable.
        :param pulumi.Input[_builtins.str] tls_key: Client TLS key (file path or literal value) to use to authenticate to the Grafana server. May alternatively be set via the `GRAFANA_TLS_KEY` environment variable.
        :param pulumi.Input[_builtins.str] url: The root URL of a Grafana server. May alternatively be set via the `GRAFANA_URL` environment variable.
        """
        if auth is None:
    ...
    def cloud_api_url(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def cloud_api_url(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "cloud_api_url", value)

    @_builtins.property
    @pulumi.getter(name="cloudProviderAccessToken")
    def cloud_provider_access_token(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def cloud_provider_access_token(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def connections_api_access_token(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def connections_api_access_token(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def fleet_management_auth(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def fleet_management_auth(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def frontend_o11y_api_access_token(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def k6_url(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @k6_url.setter
    def k6_url(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def oncall_access_token(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @oncall_url.setter
    def oncall_url(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def retry_status_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def retry_status_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def sm_access_token(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def sm_access_token(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @stack_id.setter
    def stack_id(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "stack_id", value)

    @_builtins.property
    @pulumi.getter(name="storeDashboardSha256")
    def store_dashboard_sha256(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def store_dashboard_sha256(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def tls_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @tls_key.setter
    def tls_key(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @_builtins.property
    @pulumi.getter(name="cloudApiUrl")
    def cloud_api_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Grafana Cloud's API URL. May alternatively be set via the `GRAFANA_CLOUD_API_URL` environment variable.
        """
        return pulumi.get(self, "cloud_api_url")
    ...
    @_builtins.property
    @pulumi.getter(name="cloudProviderAccessToken")
    def cloud_provider_access_token(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Cloud Provider access token. May alternatively be set via the `GRAFANA_CLOUD_PROVIDER_ACCESS_TOKEN` environment variable.
        """
        return pulumi.get(self, "cloud_provider_access_token")
    ...
    @_builtins.property
    @pulumi.getter(name="cloudProviderUrl")
    def cloud_provider_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Cloud Provider backend address. May alternatively be set via the `GRAFANA_CLOUD_PROVIDER_URL` environment variable.
        """
        return pulumi.get(self, "cloud_provider_url")
    ...
    @_builtins.property
    @pulumi.getter(name="connectionsApiAccessToken")
    def connections_api_access_token(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Connections API access token. May alternatively be set via the `GRAFANA_CONNECTIONS_API_ACCESS_TOKEN` environment variable.
        """
        return pulumi.get(self, "connections_api_access_token")
    ...
    @_builtins.property
    @pulumi.getter(name="connectionsApiUrl")
    def connections_api_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Connections API address. May alternatively be set via the `GRAFANA_CONNECTIONS_API_URL` environment variable.
        """
        return pulumi.get(self, "connections_api_url")
    ...
    @_builtins.property
    @pulumi.getter(name="fleetManagementAuth")
    def fleet_management_auth(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Fleet Management basic auth in the `username:password` format. May alternatively be set via the `GRAFANA_FLEET_MANAGEMENT_AUTH` environment variable.
        """
        return pulumi.get(self, "fleet_management_auth")
    ...
    @_builtins.property
    @pulumi.getter(name="fleetManagementUrl")
    def fleet_management_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Fleet Management API address. May alternatively be set via the `GRAFANA_FLEET_MANAGEMENT_URL` environment variable.
        """
        return pulumi.get(self, "fleet_management_url")
    ...
    @_builtins.property
    @pulumi.getter(name="frontendO11yApiAccessToken")
    def frontend_o11y_api_access_token(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Grafana Frontend Observability API access token. May alternatively be set via the `GRAFANA_FRONTEND_O11Y_API_ACCESS_TOKEN` environment variable.
        """
        return pulumi.get(self, "frontend_o11y_api_access_token")
    ...
    @_builtins.property
    @pulumi.getter(name="k6AccessToken")
    def k6_access_token(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The k6 Cloud API token. May alternatively be set via the `GRAFANA_K6_ACCESS_TOKEN` environment variable.
        """
        return pulumi.get(self, "k6_access_token")
    ...
    @_builtins.property
    @pulumi.getter(name="k6Url")
    def k6_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The k6 Cloud API url. May alternatively be set via the `GRAFANA_K6_URL` environment variable.
        """
        return pulumi.get(self, "k6_url")
    ...
    @_builtins.property
    @pulumi.getter(name="smAccessToken")
    def sm_access_token(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A Synthetic Monitoring access token. May alternatively be set via the `GRAFANA_SM_ACCESS_TOKEN` environment variable.
        """
        return pulumi.get(self, "sm_access_token")
    ...
    @_builtins.property
    @pulumi.getter(name="smUrl")
    def sm_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Synthetic monitoring backend address. May alternatively be set via the `GRAFANA_SM_URL` environment variable. The correct value for each service region is cited in the [Synthetic Monitoring documentation](https://grafana.com/docs/grafana-cloud/testing/synthetic-monitoring/set-up/set-up-private-probes/#probe-api-server-url). Note the `sm_url` value is optional, but it must correspond with the value specified as the `region_slug` in the `cloud.Stack` resource. Also note that when a Terraform configuration contains multiple provider instances managing SM resources associated with the same Grafana stack, specifying an explicit `sm_url` set to the same value for each provider ensures all providers interact with the same SM API.
        """
        return pulumi.get(self, "sm_url")
    ...
    @_builtins.property
    @pulumi.getter(name="tlsCert")
    def tls_cert(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Client TLS certificate (file path or literal value) to use to authenticate to the Grafana server. May alternatively be set via the `GRAFANA_TLS_CERT` environment variable.
        """
        return pulumi.get(self, "tls_cert")
    ...
    @_builtins.property
    @pulumi.getter(name="tlsKey")
    def tls_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Client TLS key (file path or literal value) to use to authenticate to the Grafana server. May alternatively be set via the `GRAFANA_TLS_KEY` environment variable.
        """
        return pulumi.get(self, "tls_key")
