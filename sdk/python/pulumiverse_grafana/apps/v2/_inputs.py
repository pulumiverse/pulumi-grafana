...
class DashboardSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] json: The JSON representation of the dashboard v2 spec. Must be the spec object only — not the full Kubernetes envelope. Use: json = jsonencode(jsondecode(file("dashboard.json")).spec)
