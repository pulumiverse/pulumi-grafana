...
class MachineLearningHolidayCustomPeriod(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the custom period.
        """
...
class MachineLearningOutlierDetectorAlgorithm(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the algorithm to use ('mad' or 'dbscan').
        :param builtins.float sensitivity: Specify the sensitivity of the detector (in range [0,1]).
...
class MachineLearningOutlierDetectorAlgorithmConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float epsilon: Specify the epsilon parameter (positive float)
        """
