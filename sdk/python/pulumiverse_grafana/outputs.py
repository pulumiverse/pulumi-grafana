...
__all__ = [
    'AppsProductactivationDbo11yconfigV1alpha1Metadata',
    'AppsProductactivationDbo11yconfigV1alpha1Options',
    'AppsProductactivationDbo11yconfigV1alpha1Spec',
]

@pulumi.output_type
class AppsProductactivationDbo11yconfigV1alpha1Metadata(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AppsProductactivationDbo11yconfigV1alpha1Metadata. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AppsProductactivationDbo11yconfigV1alpha1Metadata.__key_warning(key)
...
@pulumi.output_type
class AppsProductactivationDbo11yconfigV1alpha1Options(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AppsProductactivationDbo11yconfigV1alpha1Options. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AppsProductactivationDbo11yconfigV1alpha1Options.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class AppsProductactivationDbo11yconfigV1alpha1Spec(dict):
    def __init__(__self__, *,
