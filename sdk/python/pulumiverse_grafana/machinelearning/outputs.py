...
class HolidayCustomPeriod(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the custom period.
        """
...
class OutlierDetectorAlgorithm(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the algorithm to use ('mad' or 'dbscan').
        :param _builtins.float sensitivity: Specify the sensitivity of the detector (in range [0,1]).
...
class OutlierDetectorAlgorithmConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.float epsilon: Specify the epsilon parameter (positive float)
        """
