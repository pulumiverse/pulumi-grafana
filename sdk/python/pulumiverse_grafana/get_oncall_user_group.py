...
class GetOncallUserGroupResult:
    ...
    def slack_handle(self) -> builtins.str:
...
def get_oncall_user_group(slack_handle: Optional[builtins.str] = None,
...
def get_oncall_user_group_output(slack_handle: Optional[pulumi.Input[builtins.str]] = None,
