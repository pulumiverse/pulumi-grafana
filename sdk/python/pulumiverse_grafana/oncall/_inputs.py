...
if not MYPY:
    class IntegrationDefaultRouteArgsDict(TypedDict):
        escalation_chain_id: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class IntegrationDefaultRouteMsteamsArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.bool] enabled: Enable notification in MS teams. Defaults to `true`.
        :param pulumi.Input[_builtins.str] id: MS teams channel id. Alerts will be directed to this channel in Microsoft teams.
        """
...
class IntegrationDefaultRouteSlackArgs:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] channel_id: Slack channel id. Alerts will be directed to this channel in Slack.
        :param pulumi.Input[_builtins.bool] enabled: Enable notification in Slack. Defaults to `true`.
        """
...
class IntegrationDefaultRouteTelegramArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.bool] enabled: Enable notification in Telegram. Defaults to `true`.
        :param pulumi.Input[_builtins.str] id: Telegram channel id. Alerts will be directed to this channel in Telegram.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if id is not None:
...
if not MYPY:
    class IntegrationTemplatesArgsDict(TypedDict):
        acknowledge_signal: NotRequired[pulumi.Input[_builtins.str]]
        """
        ...
        Templates for Email.
        """
        grouping_key: NotRequired[pulumi.Input[_builtins.str]]
        """
        ...
        """
        resolve_signal: NotRequired[pulumi.Input[_builtins.str]]
        """
        ...
        Templates for SMS.
        """
        source_link: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class IntegrationTemplatesArgs:
    def __init__(__self__, *,
                 acknowledge_signal: Optional[pulumi.Input[_builtins.str]] = None,
                 email: Optional[pulumi.Input['IntegrationTemplatesEmailArgs']] = None,
                 grouping_key: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        """
        :param pulumi.Input[_builtins.str] acknowledge_signal: Template for sending a signal to acknowledge the Incident.
        :param pulumi.Input['IntegrationTemplatesEmailArgs'] email: Templates for Email.
        :param pulumi.Input[_builtins.str] grouping_key: Template for the key by which alerts are grouped.
        ...
        :param pulumi.Input[_builtins.str] resolve_signal: Template for sending a signal to resolve the Incident.
        ...
        :param pulumi.Input[_builtins.str] source_link: Template for a source link.
    ...
    def acknowledge_signal(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Template for sending a signal to acknowledge the Incident.
        """
    ...
    def acknowledge_signal(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def grouping_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Template for the key by which alerts are grouped.
        """
    ...
    @grouping_key.setter
    def grouping_key(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def resolve_signal(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Template for sending a signal to resolve the Incident.
        """
    ...
    def resolve_signal(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def source_link(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Template for a source link.
        """
    ...
    @source_link.setter
    def source_link(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class IntegrationTemplatesEmailArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] message: Template for Alert message.
        :param pulumi.Input[_builtins.str] title: Template for Alert title.
        """
...
class IntegrationTemplatesMicrosoftTeamsArgs:
    def __init__(__self__, *,
                 ...
                 title: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] image_url: Template for Alert image url.
        :param pulumi.Input[_builtins.str] message: Template for Alert message.
        :param pulumi.Input[_builtins.str] title: Template for Alert title.
        """
...
class ScheduleSlackArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] channel_id: Slack channel id. Reminder about schedule shifts will be directed to this channel in Slack.
        :param pulumi.Input[_builtins.str] user_group_id: Slack user group id. Members of user group will be updated when on-call users change.
        """
        if channel_id is not None:
            pulumi.set(__self__, "channel_id", channel_id)
