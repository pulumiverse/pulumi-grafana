...
def get_escalation_chain(name: Optional[_builtins.str] = None,
    ...
    * [HTTP API](https://grafana.com/docs/oncall/latest/oncall-api-reference/escalation_chains/)
    ...
    :param _builtins.str name: The escalation chain name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_escalation_chain_output(name: Optional[pulumi.Input[_builtins.str]] = None,
