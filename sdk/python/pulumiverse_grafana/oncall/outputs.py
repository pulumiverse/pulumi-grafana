...
class IntegrationDefaultRoute(dict):
    ...
    def __init__(__self__, *,
                 escalation_chain_id: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str escalation_chain_id: The ID of the escalation chain.
    ...
    def escalation_chain_id(self) -> Optional[_builtins.str]:
        """
...
class IntegrationDefaultRouteMsteams(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enabled: Enable notification in MS teams. Defaults to `true`.
        :param _builtins.str id: MS teams channel id. Alerts will be directed to this channel in Microsoft teams.
        """
...
class IntegrationDefaultRouteSlack(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.str channel_id: Slack channel id. Alerts will be directed to this channel in Slack.
        :param _builtins.bool enabled: Enable notification in Slack. Defaults to `true`.
        """
...
class IntegrationDefaultRouteTelegram(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enabled: Enable notification in Telegram. Defaults to `true`.
        :param _builtins.str id: Telegram channel id. Alerts will be directed to this channel in Telegram.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if id is not None:
...
class IntegrationTemplates(dict):
    ...
    def __init__(__self__, *,
                 acknowledge_signal: Optional[_builtins.str] = None,
                 email: Optional['outputs.IntegrationTemplatesEmail'] = None,
                 grouping_key: Optional[_builtins.str] = None,
        ...
        :param _builtins.str resolve_signal: Template for sending a signal to resolve the Incident.
        :param 'IntegrationTemplatesSlackArgs' slack: Templates for Slack.
        :param 'IntegrationTemplatesSmsArgs' sms: Templates for SMS.
        :param _builtins.str source_link: Template for a source link.
    ...
    def acknowledge_signal(self) -> Optional[_builtins.str]:
        """
    ...
    def grouping_key(self) -> Optional[_builtins.str]:
        """
    ...
    def resolve_signal(self) -> Optional[_builtins.str]:
        """
    ...
    def source_link(self) -> Optional[_builtins.str]:
        """
...
class IntegrationTemplatesEmail(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str message: Template for Alert message.
        :param _builtins.str title: Template for Alert title.
        """
...
class IntegrationTemplatesMicrosoftTeams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 title: Optional[_builtins.str] = None):
        """
        :param _builtins.str image_url: Template for Alert image url.
        :param _builtins.str message: Template for Alert message.
        :param _builtins.str title: Template for Alert title.
        """
...
class ScheduleSlack(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str channel_id: Slack channel id. Reminder about schedule shifts will be directed to this channel in Slack.
        :param _builtins.str user_group_id: Slack user group id. Members of user group will be updated when on-call users change.
        """
        if channel_id is not None:
            pulumi.set(__self__, "channel_id", channel_id)
