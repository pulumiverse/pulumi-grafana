...
class GetSlackChannelResult:
    ...
    def slack_id(self) -> _builtins.str:
        """
...
def get_slack_channel(name: Optional[_builtins.str] = None,
    ...
    * [HTTP API](https://grafana.com/docs/oncall/latest/oncall-api-reference/slack_channels/)
    ...
    :param _builtins.str name: The Slack channel name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_slack_channel_output(name: Optional[pulumi.Input[_builtins.str]] = None,
