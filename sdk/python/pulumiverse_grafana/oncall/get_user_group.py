...
class GetUserGroupResult:
    ...
    def slack_handle(self) -> _builtins.str:
...
def get_user_group(slack_handle: Optional[_builtins.str] = None,
...
def get_user_group_output(slack_handle: Optional[pulumi.Input[_builtins.str]] = None,
