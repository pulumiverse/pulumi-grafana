...
def get_oncall_schedule(name: Optional[builtins.str] = None,
    ...
    * [HTTP API](https://grafana.com/docs/oncall/latest/oncall-api-reference/schedules/)
    ...
    :param builtins.str name: The schedule name.
    """
...
def get_oncall_schedule_output(name: Optional[pulumi.Input[builtins.str]] = None,
