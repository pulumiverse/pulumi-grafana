...
class OncallScheduleArgs:
    def __init__(__self__, *,
                 ...
                 enable_web_overrides: Optional[pulumi.Input[builtins.bool]] = None,
                 ical_url_overrides: Optional[pulumi.Input[builtins.str]] = None,
                 ical_url_primary: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 shifts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def enable_web_overrides(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_web_overrides(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_web_overrides", value)

    @property
    @pulumi.getter(name="icalUrlOverrides")
    def ical_url_overrides(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ical_url_overrides(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ical_url_overrides", value)

    @property
    @pulumi.getter(name="icalUrlPrimary")
    def ical_url_primary(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ical_url_primary(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def shifts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @shifts.setter
    def shifts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("grafana:index/oncallSchedule:OncallSchedule")
class OncallSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'OncallSchedule':
        """
    ...
    @property
    @pulumi.getter(name="enableWebOverrides")
    def enable_web_overrides(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable overrides via web UI (it will ignore ical*url*overrides).
        """
        return pulumi.get(self, "enable_web_overrides")
    ...
    @property
    @pulumi.getter(name="icalUrlOverrides")
    def ical_url_overrides(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of external iCal calendar which override primary events.
        """
        return pulumi.get(self, "ical_url_overrides")
    ...
    @property
    @pulumi.getter(name="icalUrlPrimary")
    def ical_url_primary(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of the external calendar iCal file.
        """
        return pulumi.get(self, "ical_url_primary")
    ...
    @property
    @pulumi.getter
    def shifts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of ID's of on-call shifts.
        """
        return pulumi.get(self, "shifts")
