...
class MachineLearningOutlierDetectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MachineLearningOutlierDetectorAlgorithmArgs'] algorithm: The algorithm to use and its configuration. See
        ...
        :param pulumi.Input[builtins.str] metric: The metric used to query the outlier detector results.
        ...
        :param pulumi.Input[builtins.str] description: A description of the outlier detector.
        :param pulumi.Input[builtins.int] interval: The data interval in seconds to monitor.
        :param pulumi.Input[builtins.str] name: The name of the outlier detector.
        """
...
warnings.warn("""grafana.index/machinelearningoutlierdetector.MachineLearningOutlierDetector has been deprecated in favor of grafana.machinelearning/outlierdetector.OutlierDetector""", DeprecationWarning)


@pulumi.type_token("grafana:index/machineLearningOutlierDetector:MachineLearningOutlierDetector")
class MachineLearningOutlierDetector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['MachineLearningOutlierDetectorAlgorithmArgs', 'MachineLearningOutlierDetectorAlgorithmArgsDict']] algorithm: The algorithm to use and its configuration. See
               https://grafana.com/docs/grafana-cloud/machine-learning/outlier-detection/ for details.
        :param pulumi.Input[builtins.str] datasource_type: The type of datasource being queried. Currently allowed values are prometheus, graphite, loki, postgres, influxdb,
               snowflake, splunk, elasticsearch, bigquery, mongodb, and datadog.
        :param pulumi.Input[builtins.str] datasource_uid: The uid of the datasource to query.
    ...
    def get(resource_name: str,
            ...
            metric: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            query_params: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'MachineLearningOutlierDetector':
        """
