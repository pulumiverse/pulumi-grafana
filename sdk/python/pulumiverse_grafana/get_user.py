...
warnings.warn("""grafana.index/getuser.getUser has been deprecated in favor of grafana.oss/getuser.getUser""", DeprecationWarning)
...
def get_user(email: Optional[builtins.str] = None,
    ...
    * [HTTP API](https://grafana.com/docs/grafana/latest/developers/http_api/user/)
    ...
    :param builtins.str email: The email address of the Grafana user. Defaults to ``.
    :param builtins.str login: The username for the Grafana user. Defaults to ``.
    :param builtins.int user_id: The numerical ID of the Grafana user. Defaults to `-1`.
    """
...
def get_user_output(email: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    login: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    * [HTTP API](https://grafana.com/docs/grafana/latest/developers/http_api/user/)
    ...
    __ret__ = pulumi.runtime.invoke_output('grafana:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult)
