...
class OrganizationPreferencesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] home_dashboard_uid: The Organization home dashboard UID. This is only available in Grafana 9.0+.
        ...
        :param pulumi.Input[builtins.str] theme: The Organization theme. Available values are `light`, `dark`, `system`, or an empty string for the default.
        :param pulumi.Input[builtins.str] timezone: The Organization timezone. Available values are `utc`, `browser`, or an empty string for the default.
        :param pulumi.Input[builtins.str] week_start: The Organization week start day. Available values are `sunday`, `monday`, `saturday`, or an empty string for the default. Defaults to ``.
        """
...
warnings.warn("""grafana.index/organizationpreferences.OrganizationPreferences has been deprecated in favor of grafana.oss/organizationpreferences.OrganizationPreferences""", DeprecationWarning)


@pulumi.type_token("grafana:index/organizationPreferences:OrganizationPreferences")
class OrganizationPreferences(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(OrganizationPreferences, __self__).__init__(
            'grafana:index/organizationPreferences:OrganizationPreferences',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            theme: Optional[pulumi.Input[builtins.str]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            week_start: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationPreferences':
        """
    ...
    @property
    @pulumi.getter(name="homeDashboardUid")
    def home_dashboard_uid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Organization home dashboard UID. This is only available in Grafana 9.0+.
        """
        return pulumi.get(self, "home_dashboard_uid")
