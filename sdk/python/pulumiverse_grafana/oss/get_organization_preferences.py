...
def get_organization_preferences(org_id: Optional[_builtins.str] = None,
    ...
    * [HTTP API](https://grafana.com/docs/grafana/latest/developers/http_api/preferences/#get-current-org-prefs)
    ...
    __ret__ = pulumi.runtime.invoke('grafana:oss/getOrganizationPreferences:getOrganizationPreferences', __args__, opts=opts, typ=GetOrganizationPreferencesResult).value
...
def get_organization_preferences_output(org_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
