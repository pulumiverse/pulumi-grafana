...
def get_organization_preferences(org_id: Optional[builtins.str] = None,
...
def get_organization_preferences_output(org_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
