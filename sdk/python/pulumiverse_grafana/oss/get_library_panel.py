...
class GetLibraryPanelResult:
    ...
    def dashboard_ids(self) -> Sequence[_builtins.int]:
        """
...
def get_library_panel(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str uid: The unique identifier (UID) of the library panel.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_library_panel_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
