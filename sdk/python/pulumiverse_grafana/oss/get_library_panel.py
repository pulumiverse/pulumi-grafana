...
class GetLibraryPanelResult:
    ...
    def dashboard_ids(self) -> Sequence[builtins.int]:
        """
    ...
    def panel_id(self) -> builtins.int:
        """
...
def get_library_panel(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the library panel.
    :param builtins.str org_id: The Organization ID. If not set, the Org ID defined in the provider block will be used.
    :param builtins.str uid: The unique identifier (UID) of the library panel.
    """
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('grafana:oss/getLibraryPanel:getLibraryPanel', __args__, opts=opts, typ=GetLibraryPanelResult).value
...
def get_library_panel_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
