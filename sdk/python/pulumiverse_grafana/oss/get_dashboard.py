...
class GetDashboardResult:
    ...
    def dashboard_id(self) -> Optional[_builtins.int]:
        """
    ...
    def is_starred(self) -> _builtins.bool:
        """
...
def get_dashboard(dashboard_id: Optional[_builtins.int] = None,
    ...
    * [Dashboard HTTP API](https://grafana.com/docs/grafana/latest/developers/http_api/dashboard/)
    ...
    :param _builtins.int dashboard_id: The numerical ID of the Grafana dashboard. Specify either this or `uid`. Defaults to `-1`.
    :param _builtins.str org_id: The Organization ID. If not set, the Org ID defined in the provider block will be used.
    :param _builtins.str uid: The uid of the Grafana dashboard. Specify either this or `dashboard_id`. Defaults to ``.
    """
    __args__ = dict()
...
def get_dashboard_output(dashboard_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
