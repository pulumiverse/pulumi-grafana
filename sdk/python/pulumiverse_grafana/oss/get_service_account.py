...
def get_service_account(name: Optional[builtins.str] = None,
    ...
    * [Official documentation](https://grafana.com/docs/grafana/latest/administration/service-accounts/)
    ...
    :param builtins.str name: The name of the Service Account.
...
def get_service_account_output(name: Optional[pulumi.Input[builtins.str]] = None,
