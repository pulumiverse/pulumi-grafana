...
class GetDataSourceResult:
    ...
    def basic_auth_username(self) -> _builtins.str:
        """
        Basic auth username.
        """
    ...
    def json_data_encoded(self) -> _builtins.str:
        """
    ...
    def private_data_source_connect_network_id(self) -> _builtins.str:
        """
...
def get_data_source(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('grafana:oss/getDataSource:getDataSource', __args__, opts=opts, typ=GetDataSourceResult).value
...
def get_data_source_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
