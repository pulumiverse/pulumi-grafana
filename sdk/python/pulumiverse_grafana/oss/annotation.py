...
class AnnotationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] time_end: The RFC 3339-formatted time string indicating the annotation's end time.
        """
...
class Annotation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            text: Optional[pulumi.Input[_builtins.str]] = None,
            time: Optional[pulumi.Input[_builtins.str]] = None,
            time_end: Optional[pulumi.Input[_builtins.str]] = None) -> 'Annotation':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dashboardUid")
    def dashboard_uid(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The UID of the dashboard on which to create the annotation.
        """
        return pulumi.get(self, "dashboard_uid")
    ...
    @_builtins.property
    @pulumi.getter(name="panelId")
    def panel_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The ID of the dashboard panel on which to create the annotation.
        """
        return pulumi.get(self, "panel_id")
