...
class FolderArgs:
    def __init__(__self__, *,
                 ...
                 parent_folder_uid: Optional[pulumi.Input[_builtins.str]] = None,
                 prevent_destroy_if_not_empty: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] uid: Unique identifier.
        """
    ...
    def parent_folder_uid(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def parent_folder_uid(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "parent_folder_uid", value)

    @_builtins.property
    @pulumi.getter(name="preventDestroyIfNotEmpty")
    def prevent_destroy_if_not_empty(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def prevent_destroy_if_not_empty(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _FolderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] title: The title of the folder.
        :param pulumi.Input[_builtins.str] uid: Unique identifier.
        :param pulumi.Input[_builtins.str] url: The full URL of the folder.
        """
        if org_id is not None:
            pulumi.set(__self__, "org_id", org_id)
        if parent_folder_uid is not None:
...
class Folder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[_builtins.str]] = None,
            uid: Optional[pulumi.Input[_builtins.str]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None) -> 'Folder':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="parentFolderUid")
    def parent_folder_uid(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The uid of the parent folder. If set, the folder will be nested. If not set, the folder will be created in the root folder. Note: This requires the nestedFolders feature flag to be enabled on your Grafana instance.
        """
        return pulumi.get(self, "parent_folder_uid")
    ...
    @_builtins.property
    @pulumi.getter(name="preventDestroyIfNotEmpty")
    def prevent_destroy_if_not_empty(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Prevent deletion of the folder if it is not empty (contains dashboards or alert rules). This feature requires Grafana 10.2 or later. Defaults to `false`.
        """
        return pulumi.get(self, "prevent_destroy_if_not_empty")
