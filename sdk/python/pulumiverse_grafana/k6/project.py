...
class _ProjectState:
    def __init__(__self__, *,
                 ...
                 grafana_folder_uid: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Human-friendly identifier of the project.
        :param pulumi.Input[_builtins.str] updated: The date when the project was last updated.
        """
    ...
    def grafana_folder_uid(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def grafana_folder_uid(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Project(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="grafanaFolderUid")
    def grafana_folder_uid(self) -> pulumi.Output[_builtins.str]:
        """
        The Grafana folder uid.
        """
        return pulumi.get(self, "grafana_folder_uid")
