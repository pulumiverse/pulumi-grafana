...
class LibraryPanelArgs:
    def __init__(__self__, *,
                 model_json: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] model_json: The JSON model for the library panel.
        :param pulumi.Input[builtins.str] folder_uid: Unique ID (UID) of the folder containing the library panel.
        :param pulumi.Input[builtins.str] name: Name of the library panel.
        ...
        :param pulumi.Input[builtins.str] uid: The unique identifier (UID) of a library panel uniquely identifies library panels between multiple Grafana installs. It’s automatically generated unless you specify it during library panel creation.The UID provides consistent URLs for accessing library panels and when syncing library panels between multiple Grafana installs.
        """
    ...
    def model_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @model_json.setter
    def model_json(self, value: pulumi.Input[builtins.str]):
...
class _LibraryPanelState:
    def __init__(__self__, *,
                 ...
                 dashboard_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 folder_name: Optional[pulumi.Input[builtins.str]] = None,
                 folder_uid: Optional[pulumi.Input[builtins.str]] = None,
                 model_json: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 org_id: Optional[pulumi.Input[builtins.str]] = None,
                 panel_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] created: Timestamp when the library panel was created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] dashboard_ids: Numerical IDs of Grafana dashboards containing the library panel.
        :param pulumi.Input[builtins.str] description: Description of the library panel.
        :param pulumi.Input[builtins.str] folder_name: Name of the folder containing the library panel.
        :param pulumi.Input[builtins.str] folder_uid: Unique ID (UID) of the folder containing the library panel.
        :param pulumi.Input[builtins.str] model_json: The JSON model for the library panel.
        :param pulumi.Input[builtins.str] name: Name of the library panel.
        :param pulumi.Input[builtins.str] org_id: The Organization ID. If not set, the Org ID defined in the provider block will be used.
        :param pulumi.Input[builtins.int] panel_id: The numeric ID of the library panel computed by Grafana.
        :param pulumi.Input[builtins.str] type: Type of the library panel (eg. text).
        :param pulumi.Input[builtins.str] uid: The unique identifier (UID) of a library panel uniquely identifies library panels between multiple Grafana installs. It’s automatically generated unless you specify it during library panel creation.The UID provides consistent URLs for accessing library panels and when syncing library panels between multiple Grafana installs.
        :param pulumi.Input[builtins.str] updated: Timestamp when the library panel was last modified.
        :param pulumi.Input[builtins.int] version: Version of the library panel.
        """
    ...
    def dashboard_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    def dashboard_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    @property
    @pulumi.getter(name="modelJson")
    def model_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The JSON model for the library panel.
        """
        return pulumi.get(self, "model_json")
    ...
    @model_json.setter
    def model_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "model_json", value)
    ...
    def panel_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @panel_id.setter
    def panel_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
warnings.warn("""grafana.index/librarypanel.LibraryPanel has been deprecated in favor of grafana.oss/librarypanel.LibraryPanel""", DeprecationWarning)


@pulumi.type_token("grafana:index/libraryPanel:LibraryPanel")
class LibraryPanel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            uid: Optional[pulumi.Input[builtins.str]] = None,
            updated: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'LibraryPanel':
        """
    ...
    @property
    @pulumi.getter(name="dashboardIds")
    def dashboard_ids(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        Numerical IDs of Grafana dashboards containing the library panel.
        """
        return pulumi.get(self, "dashboard_ids")
    ...
    @property
    @pulumi.getter(name="folderUid")
    def folder_uid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Unique ID (UID) of the folder containing the library panel.
        """
        return pulumi.get(self, "folder_uid")
    ...
    @property
    @pulumi.getter(name="modelJson")
    def model_json(self) -> pulumi.Output[builtins.str]:
        """
        The JSON model for the library panel.
        """
        return pulumi.get(self, "model_json")
    ...
    @property
    @pulumi.getter(name="panelId")
    def panel_id(self) -> pulumi.Output[builtins.int]:
        """
        The numeric ID of the library panel computed by Grafana.
        """
        return pulumi.get(self, "panel_id")
