...
__all__ = [
    'AppsDashboardV1Alpha1Metadata',
    'AppsDashboardV1Alpha1Options',
    'AppsDashboardV1Alpha1Spec',
...
@pulumi.output_type
class AppsDashboardV1Alpha1Metadata(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AppsDashboardV1Alpha1Metadata. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AppsDashboardV1Alpha1Metadata.__key_warning(key)
...
@pulumi.output_type
class AppsDashboardV1Alpha1Options(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class AppsDashboardV1Alpha1Spec(dict):
    def __init__(__self__, *,
                 json: builtins.str,
