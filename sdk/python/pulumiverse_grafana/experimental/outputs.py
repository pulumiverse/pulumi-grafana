...
class AppsDashboardSpec(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str json: The JSON representation of the dashboard spec.
...
class AppsPlaylistV0Alpha1Options(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AppsPlaylistV0Alpha1Options. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AppsPlaylistV0Alpha1Options.__key_warning(key)
        return super().__getitem__(key)
