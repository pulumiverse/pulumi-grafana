...
class SLOArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SLODestinationDatasourceArgs'] destination_datasource: **Required.** Destination Datasource sets the datasource defined for an SLO.
        :param pulumi.Input[_builtins.str] folder_uid: UID for the SLO folder. Must be non-empty if set; omit the attribute entirely to associate the SLO with the default Grafana SLO folder.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SLOObjectiveArgs']]] objectives: **Required.** Over each rolling time window, the remaining error budget will be calculated, and separate alerts can be generated for each time window based on the SLO burn rate or remaining error budget.
        :param pulumi.Input[Sequence[pulumi.Input['SLOQueryArgs']]] queries: **Required.** Query describes the indicator that will be measured against the objective. Freeform Query types are currently supported.
        :param pulumi.Input[_builtins.str] search_expression: The name of a search expression in Grafana Asserts. Must be non-empty if set; omit the attribute entirely to leave it unset. This is used in the SLO UI to open the Asserts RCA workbench and in alerts to link to the RCA workbench.
...
class SLO(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * [Additional Information On Alerting Rule Annotations and Labels](https://prometheus.io/docs/prometheus/latest/configuration/alerting_rules/#templating/)
        ...
        :param pulumi.Input[Union['SLOAlertingArgs', 'SLOAlertingArgsDict']] alerting: Configures the alerting rules that will be generated for each
               			...
               			error budget is below a certain threshold. Annotations and Labels support templating.
        :param pulumi.Input[_builtins.str] description: Description is a free-text field that can provide more context to an SLO.
        :param pulumi.Input[Union['SLODestinationDatasourceArgs', 'SLODestinationDatasourceArgsDict']] destination_datasource: **Required.** Destination Datasource sets the datasource defined for an SLO.
        :param pulumi.Input[_builtins.str] folder_uid: UID for the SLO folder. Must be non-empty if set; omit the attribute entirely to associate the SLO with the default Grafana SLO folder.
        ...
        :param pulumi.Input[_builtins.str] name: Name should be a short description of your indicator. Consider names like "API Availability"
        :param pulumi.Input[Sequence[pulumi.Input[Union['SLOObjectiveArgs', 'SLOObjectiveArgsDict']]]] objectives: **Required.** Over each rolling time window, the remaining error budget will be calculated, and separate alerts can be generated for each time window based on the SLO burn rate or remaining error budget.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SLOQueryArgs', 'SLOQueryArgsDict']]]] queries: **Required.** Query describes the indicator that will be measured against the objective. Freeform Query types are currently supported.
        :param pulumi.Input[_builtins.str] search_expression: The name of a search expression in Grafana Asserts. Must be non-empty if set; omit the attribute entirely to leave it unset. This is used in the SLO UI to open the Asserts RCA workbench and in alerts to link to the RCA workbench.
        :param pulumi.Input[_builtins.str] uuid: UUID for the SLO. Custom UUIDs can be set. If not provided, a random UUID will be generated by the API.
        """
        ...
    ...
    @_builtins.property
    @pulumi.getter
    def objectives(self) -> pulumi.Output[Optional[Sequence['outputs.SLOObjective']]]:
        """
        **Required.** Over each rolling time window, the remaining error budget will be calculated, and separate alerts can be generated for each time window based on the SLO burn rate or remaining error budget.
        """
        return pulumi.get(self, "objectives")
    ...
    @_builtins.property
    @pulumi.getter
    def queries(self) -> pulumi.Output[Optional[Sequence['outputs.SLOQuery']]]:
        """
        **Required.** Query describes the indicator that will be measured against the objective. Freeform Query types are currently supported.
        """
        return pulumi.get(self, "queries")
