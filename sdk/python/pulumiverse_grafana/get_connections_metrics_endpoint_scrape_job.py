...
def get_connections_metrics_endpoint_scrape_job(name: Optional[builtins.str] = None,
...
def get_connections_metrics_endpoint_scrape_job_output(name: Optional[pulumi.Input[builtins.str]] = None,
