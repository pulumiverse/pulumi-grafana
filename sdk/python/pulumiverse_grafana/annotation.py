...
class AnnotationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] text: The text to associate with the annotation.
        :param pulumi.Input[builtins.str] dashboard_uid: The UID of the dashboard on which to create the annotation.
        ...
        :param pulumi.Input[builtins.int] panel_id: The ID of the dashboard panel on which to create the annotation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags to associate with the annotation.
        :param pulumi.Input[builtins.str] time: The RFC 3339-formatted time string indicating the annotation's time.
        :param pulumi.Input[builtins.str] time_end: The RFC 3339-formatted time string indicating the annotation's end time.
        """
...
@pulumi.type_token("grafana:index/annotation:Annotation")
class Annotation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            text: Optional[pulumi.Input[builtins.str]] = None,
            time: Optional[pulumi.Input[builtins.str]] = None,
            time_end: Optional[pulumi.Input[builtins.str]] = None) -> 'Annotation':
        """
    ...
    @property
    @pulumi.getter(name="dashboardUid")
    def dashboard_uid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The UID of the dashboard on which to create the annotation.
        """
        return pulumi.get(self, "dashboard_uid")
    ...
    @property
    @pulumi.getter(name="panelId")
    def panel_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The ID of the dashboard panel on which to create the annotation.
        """
        return pulumi.get(self, "panel_id")
