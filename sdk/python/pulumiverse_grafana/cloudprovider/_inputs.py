...
__all__ = [
    ...
    'AwsResourceMetadataScrapeJobServiceArgsDict',
    'AwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilterArgs',
    'AwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilterArgsDict',
...
if not MYPY:
    class AwsCloudwatchScrapeJobCustomNamespaceArgsDict(TypedDict):
        ...
        """
        scrape_interval_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AwsCloudwatchScrapeJobCustomNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 scrape_interval_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the custom namespace to scrape.
        ...
        :param pulumi.Input[builtins.int] scrape_interval_seconds: The interval in seconds to scrape the custom namespace. Defaults to `300`.
        """
    ...
    def scrape_interval_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The interval in seconds to scrape the custom namespace. Defaults to `300`.
        """
    ...
    def scrape_interval_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AwsCloudwatchScrapeJobCustomNamespaceMetricArgs:
    def __init__(__self__, *,
                 ...
                 statistics: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] name: The name of the metric to scrape.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] statistics: A set of statistics to scrape.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class AwsCloudwatchScrapeJobServiceArgsDict(TypedDict):
        ...
        """
        tags_to_add_to_metrics: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AwsCloudwatchScrapeJobServiceArgs:
    def __init__(__self__, *,
                 ...
                 scrape_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 tags_to_add_to_metrics: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the service to scrape. See https://grafana.com/docs/grafana-cloud/monitor-infrastructure/monitor-cloud-provider/aws/cloudwatch-metrics/services/ for supported services.
        ...
        :param pulumi.Input[builtins.int] scrape_interval_seconds: The interval in seconds to scrape the service. See https://grafana.com/docs/grafana-cloud/monitor-infrastructure/monitor-cloud-provider/aws/cloudwatch-metrics/services/ for supported scrape intervals. Defaults to `300`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags_to_add_to_metrics: A set of tags to add to all metrics exported by this scrape job, for use in PromQL queries.
        """
        pulumi.set(__self__, "name", name)
        if metrics is not None:
            pulumi.set(__self__, "metrics", metrics)
    ...
    def tags_to_add_to_metrics(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A set of tags to add to all metrics exported by this scrape job, for use in PromQL queries.
        """
    ...
    def tags_to_add_to_metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The key of the tag filter.
        :param pulumi.Input[builtins.str] value: The value of the tag filter.
        """
...
class AwsResourceMetadataScrapeJobServiceArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 resource_discovery_tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input['AwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilterArgs']]]] = None,
                 scrape_interval_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the service to scrape. See https://grafana.com/docs/grafana-cloud/monitor-infrastructure/monitor-cloud-provider/aws/cloudwatch-metrics/services/ for supported services.
        :param pulumi.Input[Sequence[pulumi.Input['AwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilterArgs']]] resource_discovery_tag_filters: One or more configuration blocks to configure tag filters applied to discovery of resource entities in the associated AWS account. When accessing this as an attribute reference, it is a list of objects.
        :param pulumi.Input[builtins.int] scrape_interval_seconds: The interval in seconds to scrape the service. See https://grafana.com/docs/grafana-cloud/monitor-infrastructure/monitor-cloud-provider/aws/cloudwatch-metrics/services/ for supported scrape intervals. Defaults to `300`.
        """
        pulumi.set(__self__, "name", name)
        if resource_discovery_tag_filters is not None:
    ...
    @property
    @pulumi.getter(name="resourceDiscoveryTagFilters")
    def resource_discovery_tag_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilterArgs']]]]:
        """
        One or more configuration blocks to configure tag filters applied to discovery of resource entities in the associated AWS account. When accessing this as an attribute reference, it is a list of objects.
        """
        return pulumi.get(self, "resource_discovery_tag_filters")
    ...
    @resource_discovery_tag_filters.setter
    def resource_discovery_tag_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilterArgs']]]]):
        pulumi.set(self, "resource_discovery_tag_filters", value)
...
class AzureCredentialAutoDiscoveryConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subscription_id: The subscription ID of the Azure account.
        """
...
if not MYPY:
    class AzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgsDict(TypedDict):
        ...
        resource_type_name: pulumi.Input[builtins.str]
elif False:
...
class AzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs:
    ...
    def resource_type_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "resource_type_name")

    @resource_type_name.setter
    def resource_type_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationMetricConfigurationArgsDict(TypedDict):
        aggregations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
...
class AzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationMetricConfigurationArgs:
    ...
    @property
    @pulumi.getter
    def aggregations(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "aggregations")

    @aggregations.setter
    def aggregations(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class GetAwsCloudwatchScrapeJobCustomNamespaceArgs:
    ...
    @scrape_interval_seconds.setter
    def scrape_interval_seconds(self, value: builtins.int):
        pulumi.set(self, "scrape_interval_seconds", value)
...
class GetAwsCloudwatchScrapeJobCustomNamespaceMetricArgs:
    ...
    @statistics.setter
    def statistics(self, value: Sequence[builtins.str]):
        pulumi.set(self, "statistics", value)
...
class GetAwsCloudwatchScrapeJobServiceArgs:
    ...
    @tags_to_add_to_metrics.setter
    def tags_to_add_to_metrics(self, value: Sequence[builtins.str]):
        pulumi.set(self, "tags_to_add_to_metrics", value)
...
class GetAwsCloudwatchScrapeJobsScrapeJobArgs:
    ...
    def aws_account_resource_id(self, value: builtins.str):
    ...
    def disabled_reason(self, value: builtins.str):
    ...
    @export_tags.setter
    def export_tags(self, value: builtins.bool):
    ...
    @regions.setter
    def regions(self, value: Sequence[builtins.str]):
    ...
    def regions_subset_override_used(self, value: builtins.bool):
    ...
    @stack_id.setter
    def stack_id(self, value: builtins.str):
    ...
    def static_labels(self, value: Mapping[str, builtins.str]):
...
class GetAzureCredentialAutoDiscoveryConfigurationArgs:
    ...
    @subscription_id.setter
    def subscription_id(self, value: builtins.str):
        pulumi.set(self, "subscription_id", value)
...
class GetAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs:
    ...
    @resource_type_name.setter
    def resource_type_name(self, value: builtins.str):
        pulumi.set(self, "resource_type_name", value)
...
class GetAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationMetricConfigurationArgs:
    ...
    @aggregations.setter
    def aggregations(self, value: Sequence[builtins.str]):
        pulumi.set(self, "aggregations", value)
    ...
    @dimensions.setter
    def dimensions(self, value: Sequence[builtins.str]):
        pulumi.set(self, "dimensions", value)
