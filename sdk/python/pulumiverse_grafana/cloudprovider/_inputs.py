...
class AwsCloudwatchScrapeJobCustomNamespaceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name of the custom namespace to scrape.
        ...
        :param pulumi.Input[_builtins.int] scrape_interval_seconds: The interval in seconds to scrape the custom namespace. Defaults to `300`.
        """
...
class AwsCloudwatchScrapeJobCustomNamespaceMetricArgs:
    def __init__(__self__, *,
                 ...
                 statistics: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[_builtins.str] name: The name of the metric to scrape.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] statistics: A set of statistics to scrape.
        """
        pulumi.set(__self__, "name", name)
...
class AwsCloudwatchScrapeJobServiceArgs:
    ...
    def tags_to_add_to_metrics(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        A set of tags to add to all metrics exported by this scrape job, for use in PromQL queries.
        """
...
class AwsCloudwatchScrapeJobServiceResourceDiscoveryTagFilterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: The key of the tag filter.
        :param pulumi.Input[_builtins.str] value: The value of the tag filter.
        """
...
class AzureCredentialAutoDiscoveryConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subscription_id: The subscription ID of the Azure account.
        """
...
class AzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs:
    ...
    def resource_type_name(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "resource_type_name")

    @resource_type_name.setter
    def resource_type_name(self, value: pulumi.Input[_builtins.str]):
...
class AzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationMetricConfigurationArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def aggregations(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "aggregations")

    @aggregations.setter
    def aggregations(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class GetAwsCloudwatchScrapeJobCustomNamespaceArgs:
    ...
    @scrape_interval_seconds.setter
    def scrape_interval_seconds(self, value: _builtins.int):
        pulumi.set(self, "scrape_interval_seconds", value)
...
class GetAwsCloudwatchScrapeJobCustomNamespaceMetricArgs:
    ...
    @statistics.setter
    def statistics(self, value: Sequence[_builtins.str]):
        pulumi.set(self, "statistics", value)
...
class GetAwsCloudwatchScrapeJobServiceArgs:
    ...
    @tags_to_add_to_metrics.setter
    def tags_to_add_to_metrics(self, value: Sequence[_builtins.str]):
        pulumi.set(self, "tags_to_add_to_metrics", value)
...
class GetAwsCloudwatchScrapeJobsScrapeJobArgs:
    ...
    def aws_account_resource_id(self, value: _builtins.str):
    ...
    def disabled_reason(self, value: _builtins.str):
    ...
    @export_tags.setter
    def export_tags(self, value: _builtins.bool):
    ...
    @regions.setter
    def regions(self, value: Sequence[_builtins.str]):
    ...
    def regions_subset_override_used(self, value: _builtins.bool):
    ...
    @stack_id.setter
    def stack_id(self, value: _builtins.str):
    ...
    def static_labels(self, value: Mapping[str, _builtins.str]):
...
class GetAzureCredentialAutoDiscoveryConfigurationArgs:
    ...
    @subscription_id.setter
    def subscription_id(self, value: _builtins.str):
        pulumi.set(self, "subscription_id", value)
...
class GetAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationArgs:
    ...
    @resource_type_name.setter
    def resource_type_name(self, value: _builtins.str):
        pulumi.set(self, "resource_type_name", value)
...
class GetAzureCredentialAutoDiscoveryConfigurationResourceTypeConfigurationMetricConfigurationArgs:
    ...
    @aggregations.setter
    def aggregations(self, value: Sequence[_builtins.str]):
        pulumi.set(self, "aggregations", value)
    ...
    @dimensions.setter
    def dimensions(self, value: Sequence[_builtins.str]):
        pulumi.set(self, "dimensions", value)
