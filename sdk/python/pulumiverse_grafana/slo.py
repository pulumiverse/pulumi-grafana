...
class SLOArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description is a free-text field that can provide more context to an SLO.
        ...
        :param pulumi.Input[builtins.str] folder_uid: UID for the SLO folder
        ...
        :param pulumi.Input[builtins.str] name: Name should be a short description of your indicator. Consider names like "API Availability"
    ...
    def search_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def search_expression(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("grafana:index/sLO:SLO")
class SLO(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            objectives: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SLOObjectiveArgs', 'SLOObjectiveArgsDict']]]]] = None,
            queries: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SLOQueryArgs', 'SLOQueryArgsDict']]]]] = None,
            search_expression: Optional[pulumi.Input[builtins.str]] = None) -> 'SLO':
        """
    ...
    @property
    @pulumi.getter(name="searchExpression")
    def search_expression(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of a search expression in Grafana Asserts. This is used in the SLO UI to open the Asserts RCA workbench and in alerts to link to the RCA workbench.
        """
        return pulumi.get(self, "search_expression")
