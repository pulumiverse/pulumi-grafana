...
def get_library_panels(org_id: Optional[builtins.str] = None,
    ...
    :param builtins.str org_id: The Organization ID. If not set, the default organization is used for basic authentication, or the one that owns your service account for token authentication.
    """
...
def get_library_panels_output(org_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
