...
def get_collector(id: Optional[_builtins.str] = None,
    ...
    * fleet-management:read
    ...
    :param _builtins.str id: ID of the collector
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_collector_output(id: Optional[pulumi.Input[_builtins.str]] = None,
