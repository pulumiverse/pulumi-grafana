...
class PipelineArgs:
    def __init__(__self__, *,
                 ...
                 matchers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Pipeline resource.
        :param pulumi.Input[builtins.str] contents: Configuration contents of the pipeline to be used by collectors
        :param pulumi.Input[builtins.bool] enabled: Whether the pipeline is enabled for collectors
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] matchers: Used to match against collectors and assign pipelines to them; follows the syntax of Prometheus Alertmanager matchers
        :param pulumi.Input[builtins.str] name: Name of the pipeline which is the unique identifier for the pipeline
        """
    ...
    @property
    @pulumi.getter
    def matchers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @matchers.setter
    def matchers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Pipeline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            matchers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Pipeline':
        """
    ...
    @property
    @pulumi.getter
    def contents(self) -> pulumi.Output[builtins.str]:
        """
        Configuration contents of the pipeline to be used by collectors
        """
        return pulumi.get(self, "contents")
    ...
    @property
    @pulumi.getter
    def matchers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Used to match against collectors and assign pipelines to them; follows the syntax of Prometheus Alertmanager matchers
        """
        return pulumi.get(self, "matchers")
