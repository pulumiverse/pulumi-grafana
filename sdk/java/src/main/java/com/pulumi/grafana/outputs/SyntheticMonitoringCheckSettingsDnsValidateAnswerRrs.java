...
public final class SyntheticMonitoringCheckSettingsDnsValidateAnswerRrs {
    ...
    public static Builder builder(SyntheticMonitoringCheckSettingsDnsValidateAnswerRrs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> failIfNotMatchesRegexps;
        public Builder() {}
        public Builder(SyntheticMonitoringCheckSettingsDnsValidateAnswerRrs defaults) {
        ...
        public SyntheticMonitoringCheckSettingsDnsValidateAnswerRrs build() {
            final var o = new SyntheticMonitoringCheckSettingsDnsValidateAnswerRrs();
