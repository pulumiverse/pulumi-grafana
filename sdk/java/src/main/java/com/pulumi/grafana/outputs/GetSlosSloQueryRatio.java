...
public final class GetSlosSloQueryRatio {
    ...
    public static Builder builder(GetSlosSloQueryRatio defaults) {
    ...
    public static final class Builder {
        ...
        private String totalMetric;
        public Builder() {}
        public Builder(GetSlosSloQueryRatio defaults) {
        ...
        public GetSlosSloQueryRatio build() {
            final var o = new GetSlosSloQueryRatio();
