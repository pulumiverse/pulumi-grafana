...
public final class SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs Empty = new SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs();
    ...
    private SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs() {}

    private SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs(SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs $) {
    ...
    public static Builder builder(SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs();
        }

        public Builder(SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs defaults) {
            $ = new SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SyntheticMonitoringCheckSettingsDnsValidateAuthorityRrsArgs build() {
            return $;
        }
    }
