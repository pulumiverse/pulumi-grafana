...
public final class RoleAssignmentState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="roleUid")
    private @Nullable Output<String> roleUid;

    /**
     * @return Grafana RBAC role UID.
     * 
     */
    public Optional<Output<String>> roleUid() {
        return Optional.ofNullable(this.roleUid);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder roleUid(@Nullable Output<String> roleUid) {
            $.roleUid = roleUid;
            return this;
        }
